...
public enum PathPoint_V1: StitchSchemaVersionable {
...
extension PathPoint_V1.PathPoint: StitchVersionedCodable {
    public init(previousInstance: PathPoint_V1.PreviousInstance) {
        fatalError()
    }
}
