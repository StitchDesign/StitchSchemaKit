...
public enum StitchFontChoice_V1: StitchSchemaVersionable {
...
extension StitchFontChoice_V1.StitchFontChoice: StitchVersionedCodable {
    public init(previousInstance: StitchFontChoice_V1.PreviousInstance) {
        fatalError()
    }
}
