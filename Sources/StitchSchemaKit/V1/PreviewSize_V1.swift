...
public enum PreviewSize_V1: StitchSchemaVersionable {
...
extension PreviewSize_V1.PreviewSize: StitchVersionedCodable {
    public init(previousInstance: PreviewSize_V1.PreviousInstance) {
        fatalError()
    }
}
