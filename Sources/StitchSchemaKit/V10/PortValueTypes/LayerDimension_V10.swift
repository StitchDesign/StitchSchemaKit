...
public enum LayerDimension_V9: StitchSchemaVersionable {
...
extension LayerDimension_V9.LayerDimension: StitchVersionedCodable {
    public init(previousInstance: LayerDimension_V9.PreviousInstance) {
