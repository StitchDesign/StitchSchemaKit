...
public enum StitchDocument_V11: StitchSchemaVersionable {
    ...
    public typealias PreviewSize = PreviewSize_V11.PreviewSize
    public typealias SidebarLayerDataList = [SidebarLayerData_V11.SidebarLayerData]
    public typealias CameraSettings = CameraSettings_V11.CameraSettings
    // MARK: - end
...
extension StitchDocument_V11.StitchDocument {
    public init(previousInstance: StitchDocument_V11.PreviousInstance) {
        self.init(
            projectId: previousInstance.projectId,
            name: previousInstance.name,
            previewWindowSize: previousInstance.previewWindowSize,
            previewSizeDevice: PreviewSize_V11.PreviewSize(previousInstance: previousInstance.previewSizeDevice),
            ...
            nodes: StitchDocument_V11.NodeEntitySchemas(previousElements: previousInstance.nodes),
            orderedSidebarLayers: StitchDocument_V11.SidebarLayerDataList(previousElements: previousInstance.orderedSidebarLayers),
            commentBoxes: StitchDocument_V11.CommentBoxes(previousElements: previousInstance.commentBoxes),
            cameraSettings: StitchDocument_V11.CameraSettings(previousInstance: previousInstance.cameraSettings)
        )
    }
}
