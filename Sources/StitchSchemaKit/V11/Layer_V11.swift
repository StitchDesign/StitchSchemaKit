...
public enum Layer_V11: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V11
    public typealias PreviousInstance = Layer_V10.Layer
    // MARK: - endif
...
extension Layer_V11.Layer: StitchVersionedCodable {
    public init(previousInstance: Layer_V11.PreviousInstance) {
