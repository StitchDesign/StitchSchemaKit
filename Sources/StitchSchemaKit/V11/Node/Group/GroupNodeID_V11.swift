...
public enum GroupNodeID_V11: StitchSchemaVersionable {
...
extension GroupNodeID_V11.GroupNodeId: StitchVersionedCodable {
    public init(previousInstance: GroupNodeID_V11.PreviousInstance) {
