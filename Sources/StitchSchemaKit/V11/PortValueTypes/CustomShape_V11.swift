...
public enum CustomShape_V11: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V11
    public typealias PreviousInstance = CustomShape_V10.CustomShape
    // MARK: - endif
...
extension CustomShape_V11.CustomShape: StitchVersionedCodable {
    public init(previousInstance: CustomShape_V11.PreviousInstance) {
