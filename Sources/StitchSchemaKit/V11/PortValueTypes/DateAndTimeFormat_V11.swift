...
public enum DateAndTimeFormat_V11: StitchSchemaVersionable {
...
extension DateAndTimeFormat_V11.DateAndTimeFormat: StitchVersionedCodable {
    public init(previousInstance: DateAndTimeFormat_V11.PreviousInstance) {
