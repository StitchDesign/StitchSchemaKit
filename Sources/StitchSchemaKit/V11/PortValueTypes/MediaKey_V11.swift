...
public enum MediaKey_V11: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V11
    public typealias PreviousInstance = MediaKey_V10.MediaKey
    // MARK: - endif
...
extension MediaKey_V11.MediaKey: StitchVersionedCodable {
    public init(previousInstance: MediaKey_V11.PreviousInstance) {
