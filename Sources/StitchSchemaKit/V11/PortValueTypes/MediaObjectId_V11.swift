...
public enum MediaObjectId_V11: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V11
    public typealias PreviousInstance = MediaObjectId_V10.MediaObjectId
    // MARK: - endif
...
extension MediaObjectId_V11.MediaObjectId: StitchVersionedCodable {
    public init(previousInstance: MediaObjectId_V11.PreviousInstance) {
