...
public enum PathPoint_V11: StitchSchemaVersionable {
...
extension PathPoint_V11.PathPoint: StitchVersionedCodable {
    public init(previousInstance: PathPoint_V11.PreviousInstance) {
