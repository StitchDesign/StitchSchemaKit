...
public enum ShapeAndRect_V11: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V11
    public typealias PreviousInstance = ShapeAndRect_V10.ShapeAndRect
...
extension ShapeAndRect_V11.ShapeAndRect: StitchVersionedCodable {
    public init(previousInstance: ShapeAndRect_V11.PreviousInstance) {
