...
public enum StitchBlendMode_V11: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V11
    public typealias PreviousInstance = StitchBlendMode_V10.StitchBlendMode
...
extension StitchBlendMode_V11.StitchBlendMode: StitchVersionedCodable {
    public init(previousInstance: StitchBlendMode_V11.PreviousInstance) {
