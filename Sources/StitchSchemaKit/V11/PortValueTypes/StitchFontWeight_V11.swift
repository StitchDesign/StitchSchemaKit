...
public enum StitchFontWeight_V11: StitchSchemaVersionable {
...
extension StitchFontWeight_V11.StitchFontWeight: StitchVersionedCodable {
    public init(previousInstance: StitchFontWeight_V11.PreviousInstance) {
