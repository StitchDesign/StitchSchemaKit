...
public enum TriangleData_V11: StitchSchemaVersionable {
...
extension TriangleData_V11.TriangleData: StitchVersionedCodable {
    public init(previousInstance: TriangleData_V11.PreviousInstance) {
