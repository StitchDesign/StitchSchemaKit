...
public enum UserVisibleType_V11: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V11
    public typealias PreviousInstance = UserVisibleType_V10.UserVisibleType
    // MARK: - endif
...
extension UserVisibleType_V11.UserVisibleType: StitchVersionedCodable {
    public init(previousInstance: UserVisibleType_V11.PreviousInstance) {
