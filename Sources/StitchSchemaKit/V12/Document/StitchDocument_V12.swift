...
public enum StitchDocument_V12: StitchSchemaVersionable {
    ...
    public typealias SidebarLayerDataList = [SidebarLayerData_V12.SidebarLayerData]
    public typealias CameraSettings = CameraSettings_V12.CameraSettings
    // MARK: - end
...
extension StitchDocument_V12.StitchDocument {
    public init(previousInstance: StitchDocument_V12.PreviousInstance) {
        self.init(
            projectId: previousInstance.projectId,
            name: previousInstance.name,
            previewWindowSize: previousInstance.previewWindowSize,
            previewSizeDevice: PreviewSize_V12.PreviewSize(previousInstance: previousInstance.previewSizeDevice),
            ...
            nodes: StitchDocument_V12.NodeEntitySchemas(previousElements: previousInstance.nodes),
            orderedSidebarLayers: StitchDocument_V12.SidebarLayerDataList(previousElements: previousInstance.orderedSidebarLayers),
            commentBoxes: StitchDocument_V12.CommentBoxes(previousElements: previousInstance.commentBoxes),
            cameraSettings: StitchDocument_V12.CameraSettings(previousInstance: previousInstance.cameraSettings)
        )
    }
}
