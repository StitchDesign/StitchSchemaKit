...
public enum LayerInputType_V12: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V12
    public typealias PreviousInstance = LayerInputType_V11.LayerInputType
    // MARK: - endif
...
extension LayerInputType_V12.LayerInputType: StitchVersionedCodable {
    public init(previousInstance: LayerInputType_V12.PreviousInstance) {
        fatalError()
    }
}

extension LayerInputType_V12.LayerInputType {
    /// Keypath mapping to this schema version.
    public var schemaPortKeyPath: WritableKeyPath<LayerNodeEntity_V12.LayerNodeEntity, NodeConnectionType_V12.NodeConnectionType> {
        switch self {
