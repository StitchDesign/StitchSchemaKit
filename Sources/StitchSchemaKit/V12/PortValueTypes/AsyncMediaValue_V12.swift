...
public enum AsyncMediaValue_V12: StitchSchemaVersionable {
    ...
    public struct AsyncMediaValue: Codable, Equatable, Hashable {
        ...
        public var dataType: DataType_V12.DataType<MediaKey_V12.MediaKey>
        
        public init(id: MediaObjectId, dataType: DataType_V12.DataType<MediaKey_V12.MediaKey>) {
            self.id = id
            self.dataType = dataType
        }
        
        /// Optional initializer with NodeId and MediaKey_V12.MediaKey.
        public init(nodeId: NodeId,
             loopIndex: Int,
             mediaKey: MediaKey_V12.MediaKey) {
        ...
        public init(globalId: UUID, nodeId: NodeId, mediaKey: MediaKey_V12.MediaKey) {
...
extension AsyncMediaValue_V12.AsyncMediaValue: StitchVersionedCodable {
    public init(previousInstance: AsyncMediaValue_V12.PreviousInstance) {
        ...
        var dataType: DataType_V12.DataType<MediaKey_V12.MediaKey>
