...
public enum CustomShape_V12: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V12
    public typealias PreviousInstance = CustomShape_V11.CustomShape
...
extension CustomShape_V12.CustomShape: StitchVersionedCodable {
    public init(previousInstance: CustomShape_V12.PreviousInstance) {
