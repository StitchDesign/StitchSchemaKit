...
public enum LayerDimension_V12: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V12
    public typealias PreviousInstance = LayerDimension_V11.LayerDimension
    // MARK: - endif
...
extension LayerDimension_V12.LayerDimension: StitchVersionedCodable {
    public init(previousInstance: LayerDimension_V12.PreviousInstance) {
