...
public enum LayerSize_V12: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V12
    public typealias PreviousInstance = LayerSize_V11.LayerSize
...
extension LayerSize_V12.LayerSize: StitchVersionedCodable {
    public init(previousInstance: LayerSize_V12.PreviousInstance) {
