...
public enum MediaObjectId_V12: StitchSchemaVersionable {
...
extension MediaObjectId_V12.MediaObjectId: StitchVersionedCodable {
    public init(previousInstance: MediaObjectId_V12.PreviousInstance) {
