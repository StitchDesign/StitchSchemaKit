...
public enum ShapeCommand_V12: StitchSchemaVersionable {
...
extension ShapeCommand_V12.ShapeCommand: StitchVersionedCodable {
    public init(previousInstance: ShapeCommand_V12.PreviousInstance) {
...
extension ShapeCommand_V12.ShapeCommand: Codable {
