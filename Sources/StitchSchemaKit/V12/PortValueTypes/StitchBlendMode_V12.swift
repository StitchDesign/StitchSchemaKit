...
public enum StitchBlendMode_V12: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V12
    public typealias PreviousInstance = StitchBlendMode_V11.StitchBlendMode
...
extension StitchBlendMode_V12.StitchBlendMode: StitchVersionedCodable {
    public init(previousInstance: StitchBlendMode_V12.PreviousInstance) {
