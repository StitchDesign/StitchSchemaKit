...
public enum StitchJSON_V12: StitchSchemaVersionable {
...
extension StitchJSON_V12.StitchJSON: StitchVersionedCodable {
    public init(previousInstance: StitchJSON_V12.PreviousInstance) {
