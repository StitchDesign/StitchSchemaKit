...
public enum UserVisibleType_V12: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V12
    public typealias PreviousInstance = UserVisibleType_V11.UserVisibleType
    // MARK: - endif
...
extension UserVisibleType_V12.UserVisibleType: StitchVersionedCodable {
    public init(previousInstance: UserVisibleType_V12.PreviousInstance) {
