...
public enum LayerInputType_V13: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V13
    public typealias PreviousInstance = LayerInputType_V12.LayerInputType
    // MARK: - endif
...
extension LayerInputType_V13.LayerInputType: StitchVersionedCodable {
    public init(previousInstance: LayerInputType_V13.PreviousInstance) {
        fatalError()
    }
}

extension LayerInputType_V13.LayerInputType {
    /// Keypath mapping to this schema version.
    public var schemaPortKeyPath: WritableKeyPath<LayerNodeEntity_V13.LayerNodeEntity, NodeConnectionType_V13.NodeConnectionType> {
        switch self {
