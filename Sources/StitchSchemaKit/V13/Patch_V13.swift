...
public enum Patch_V13: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V13
    public typealias PreviousInstance = Patch_V12.Patch
    // MARK: - endif
...
extension Patch_V13.Patch: StitchVersionedCodable {
    public init(previousInstance: Patch_V13.PreviousInstance) {
