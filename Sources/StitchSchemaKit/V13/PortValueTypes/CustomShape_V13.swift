...
public enum CustomShape_V13: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V13
    public typealias PreviousInstance = CustomShape_V12.CustomShape
    // MARK: - endif
...
extension CustomShape_V13.CustomShape: StitchVersionedCodable {
    public init(previousInstance: CustomShape_V13.PreviousInstance) {
