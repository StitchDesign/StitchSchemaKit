...
public enum JSONShapeKeys_V13: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V13
    public typealias PreviousInstance = JSONShapeKeys_V12.JSONShapeKeys
    // MARK: - endif
...
extension JSONShapeKeys_V13.JSONShapeKeys: StitchVersionedCodable {
    public init(previousInstance: JSONShapeKeys_V13.PreviousInstance) {
        fatalError()
    }
}
