...
public enum LayerSize_V13: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V13
    public typealias PreviousInstance = LayerSize_V12.LayerSize
...
extension LayerSize_V13.LayerSize: StitchVersionedCodable {
    public init(previousInstance: LayerSize_V13.PreviousInstance) {
