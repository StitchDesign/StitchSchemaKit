...
public enum ShapeCommand_V13: StitchSchemaVersionable {
...
extension ShapeCommand_V13.ShapeCommand: StitchVersionedCodable {
    public init(previousInstance: ShapeCommand_V13.PreviousInstance) {
...
extension ShapeCommand_V13.ShapeCommand: Codable {
