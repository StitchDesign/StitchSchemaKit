...
public enum StitchBlendMode_V13: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V13
    public typealias PreviousInstance = StitchBlendMode_V12.StitchBlendMode
...
extension StitchBlendMode_V13.StitchBlendMode: StitchVersionedCodable {
    public init(previousInstance: StitchBlendMode_V13.PreviousInstance) {
