...
public enum StitchFontWeight_V13: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V13
    public typealias PreviousInstance = StitchFontWeight_V12.StitchFontWeight
    // MARK: - endif
...
extension StitchFontWeight_V13.StitchFontWeight: StitchVersionedCodable {
    public init(previousInstance: StitchFontWeight_V13.PreviousInstance) {
