...
public enum StitchMapType_V13: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V13
    public typealias PreviousInstance = StitchMapType_V12.StitchMapType
...
extension StitchMapType_V13.StitchMapType: StitchVersionedCodable {
    public init(previousInstance: StitchMapType_V13.PreviousInstance) {
