...
public enum SplitterType_V13: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V13
    public typealias PreviousInstance = SplitterType_V12.SplitterType
    // MARK: - endif
...
extension SplitterType_V13.SplitterType: StitchVersionedCodable {
    public init(previousInstance: SplitterType_V13.PreviousInstance) {
