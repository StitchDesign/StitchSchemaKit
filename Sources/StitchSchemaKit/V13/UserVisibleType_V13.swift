...
public enum UserVisibleType_V13: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V13
    public typealias PreviousInstance = UserVisibleType_V12.UserVisibleType
    // MARK: - endif
...
extension UserVisibleType_V13.UserVisibleType: StitchVersionedCodable {
    public init(previousInstance: UserVisibleType_V13.PreviousInstance) {
