...
public enum StitchDocument_V14: StitchSchemaVersionable {

    // MARK: - ensure versions are correct
    static let version = StitchSchemaVersion._V14
    public typealias PreviousInstance = StitchDocument_V13.StitchDocument
    public typealias NodeEntitySchemas = [NodeEntity_V14.NodeEntity]
    public typealias CommentBoxes = [CommentBoxData_V14.CommentBoxData]
    public typealias PreviewSize = PreviewSize_V14.PreviewSize
    public typealias SidebarLayerDataList = [SidebarLayerData_V14.SidebarLayerData]
    public typealias CameraSettings = CameraSettings_V14.CameraSettings
    // MARK: - end
...
extension StitchDocument_V14.StitchDocument {
    public init(previousInstance: StitchDocument_V14.PreviousInstance) {
        self.init(
            projectId: previousInstance.projectId,
            name: previousInstance.name,
            previewWindowSize: previousInstance.previewWindowSize,
            previewSizeDevice: PreviewSize_V14.PreviewSize(previousInstance: previousInstance.previewSizeDevice),
            ...
            nodes: StitchDocument_V14.NodeEntitySchemas(previousElements: previousInstance.nodes),
            orderedSidebarLayers: StitchDocument_V14.SidebarLayerDataList(previousElements: previousInstance.orderedSidebarLayers),
            commentBoxes: StitchDocument_V14.CommentBoxes(previousElements: previousInstance.commentBoxes),
            cameraSettings: StitchDocument_V14.CameraSettings(previousInstance: previousInstance.cameraSettings)
        )
    }
}
