...
public enum Layer_V14: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V14
    public typealias PreviousInstance = Layer_V13.Layer
    // MARK: - endif
...
extension Layer_V14.Layer: StitchVersionedCodable {
    public init(previousInstance: Layer_V14.PreviousInstance) {
