...
public enum Patch_V14: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V14
    public typealias PreviousInstance = Patch_V13.Patch
    // MARK: - endif
...
extension Patch_V14.Patch: StitchVersionedCodable {
    public init(previousInstance: Patch_V14.PreviousInstance) {
