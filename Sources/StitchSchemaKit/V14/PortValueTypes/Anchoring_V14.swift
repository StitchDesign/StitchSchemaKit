...
public enum Anchoring_V14: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V14
    public typealias PreviousInstance = Anchoring_V13.Anchoring
    // MARK: - endif
...
extension Anchoring_V14.Anchoring: StitchVersionedCodable {
    public init(previousInstance: Anchoring_V14.PreviousInstance) {
