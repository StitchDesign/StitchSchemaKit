...
public enum AsyncMediaValue_V14: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V14
    public typealias PreviousInstance = AsyncMediaValue_V13.AsyncMediaValue
    ...
    public struct AsyncMediaValue: Codable, Equatable, Hashable {
        ...
        public var dataType: DataType_V14.DataType<MediaKey_V14.MediaKey>
        
        public init(id: MediaObjectId, dataType: DataType_V14.DataType<MediaKey_V14.MediaKey>) {
            self.id = id
            self.dataType = dataType
        }
        
        /// Optional initializer with NodeId and MediaKey_V14.MediaKey.
        public init(nodeId: NodeId,
             loopIndex: Int,
             mediaKey: MediaKey_V14.MediaKey) {
        ...
        public init(globalId: UUID, nodeId: NodeId, mediaKey: MediaKey_V14.MediaKey) {
...
extension AsyncMediaValue_V14.AsyncMediaValue: StitchVersionedCodable {
    public init(previousInstance: AsyncMediaValue_V14.PreviousInstance) {
        
        var dataType: DataType_V14.DataType<MediaKey_V14.MediaKey>
