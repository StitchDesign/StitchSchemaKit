...
public enum JSONCurveTo_V14: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V14
    public typealias PreviousInstance = JSONCurveTo_V13.JSONCurveTo
    // MARK: - endif
...
extension JSONCurveTo_V14.JSONCurveTo: StitchVersionedCodable {
    public init(previousInstance: JSONCurveTo_V14.PreviousInstance) {
