...
public enum LayerSize_V14: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V14
    public typealias PreviousInstance = LayerSize_V13.LayerSize
...
extension LayerSize_V14.LayerSize: StitchVersionedCodable {
    public init(previousInstance: LayerSize_V14.PreviousInstance) {
