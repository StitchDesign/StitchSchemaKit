...
public enum MediaObjectId_V14: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V14
    public typealias PreviousInstance = MediaObjectId_V13.MediaObjectId
    // MARK: - endif
...
extension MediaObjectId_V14.MediaObjectId: StitchVersionedCodable {
    public init(previousInstance: MediaObjectId_V14.PreviousInstance) {
