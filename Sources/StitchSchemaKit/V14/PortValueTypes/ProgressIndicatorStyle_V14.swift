//
//  ProgressIndicatorStyle_V14.swift
//  StitchSchemaKit
//
...
extension ProgressIndicatorStyle_V14.ProgressIndicatorStyle: StitchVersionedCodable {
    public init(previousInstance: ProgressIndicatorStyle_V14.PreviousInstance) {
