...
public enum ShapeCommand_V14: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V14
    public typealias PreviousInstance = ShapeCommand_V13.ShapeCommand
...
extension ShapeCommand_V14.ShapeCommand: StitchVersionedCodable {
    public init(previousInstance: ShapeCommand_V14.PreviousInstance) {
...
extension ShapeCommand_V14.ShapeCommand: Codable {
