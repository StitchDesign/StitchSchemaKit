...
public enum StitchBlendMode_V14: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V14
    public typealias PreviousInstance = StitchBlendMode_V13.StitchBlendMode
...
extension StitchBlendMode_V14.StitchBlendMode: StitchVersionedCodable {
    public init(previousInstance: StitchBlendMode_V14.PreviousInstance) {
