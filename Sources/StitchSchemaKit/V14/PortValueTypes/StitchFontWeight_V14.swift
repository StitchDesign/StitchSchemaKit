...
public enum StitchFontWeight_V14: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V14
    public typealias PreviousInstance = StitchFontWeight_V13.StitchFontWeight
    // MARK: - endif
...
extension StitchFontWeight_V14.StitchFontWeight: StitchVersionedCodable {
    public init(previousInstance: StitchFontWeight_V14.PreviousInstance) {
