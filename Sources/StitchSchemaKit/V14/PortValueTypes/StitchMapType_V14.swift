...
public enum StitchMapType_V14: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V14
    public typealias PreviousInstance = StitchMapType_V13.StitchMapType
...
extension StitchMapType_V14.StitchMapType: StitchVersionedCodable {
    public init(previousInstance: StitchMapType_V14.PreviousInstance) {
