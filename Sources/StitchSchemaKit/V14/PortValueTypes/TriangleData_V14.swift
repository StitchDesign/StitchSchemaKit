...
public enum TriangleData_V14: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V14
    public typealias PreviousInstance = TriangleData_V13.TriangleData
    // MARK: - endif
...
extension TriangleData_V14.TriangleData: StitchVersionedCodable {
    public init(previousInstance: TriangleData_V14.PreviousInstance) {
