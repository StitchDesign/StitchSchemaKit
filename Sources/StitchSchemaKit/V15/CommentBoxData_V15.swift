...
public enum CommentBoxData_V15: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V15
    public typealias PreviousInstance = CommentBoxData_V14.CommentBoxData
    // MARK: - endif
...
extension CommentBoxData_V15.CommentBoxData: StitchVersionedCodable {
    public init(previousInstance: CommentBoxData_V15.PreviousInstance) {
