...
public enum StitchDocument_V15: StitchSchemaVersionable {

    // MARK: - ensure versions are correct
    static let version = StitchSchemaVersion._V15
    public typealias PreviousInstance = StitchDocument_V14.StitchDocument
    public typealias NodeEntitySchemas = [NodeEntity_V15.NodeEntity]
    public typealias CommentBoxes = [CommentBoxData_V15.CommentBoxData]
    public typealias PreviewSize = PreviewSize_V15.PreviewSize
    public typealias SidebarLayerDataList = [SidebarLayerData_V15.SidebarLayerData]
    public typealias CameraSettings = CameraSettings_V15.CameraSettings
    // MARK: - end
...
extension StitchDocument_V15.StitchDocument {
    public init(previousInstance: StitchDocument_V15.PreviousInstance) {
        self.init(
            projectId: previousInstance.projectId,
            name: previousInstance.name,
            previewWindowSize: previousInstance.previewWindowSize,
            previewSizeDevice: PreviewSize_V15.PreviewSize(previousInstance: previousInstance.previewSizeDevice),
            ...
            nodes: StitchDocument_V15.NodeEntitySchemas(previousElements: previousInstance.nodes),
            orderedSidebarLayers: StitchDocument_V15.SidebarLayerDataList(previousElements: previousInstance.orderedSidebarLayers),
            commentBoxes: StitchDocument_V15.CommentBoxes(previousElements: previousInstance.commentBoxes),
            cameraSettings: StitchDocument_V15.CameraSettings(previousInstance: previousInstance.cameraSettings)
        )
    }
}
