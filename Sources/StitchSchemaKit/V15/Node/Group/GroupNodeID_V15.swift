...
public enum GroupNodeID_V15: StitchSchemaVersionable {
...
extension GroupNodeID_V15.GroupNodeId: StitchVersionedCodable {
    public init(previousInstance: GroupNodeID_V15.PreviousInstance) {
