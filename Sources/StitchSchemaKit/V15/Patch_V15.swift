...
public enum Patch_V15: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V15
    public typealias PreviousInstance = Patch_V14.Patch
    // MARK: - endif
...
extension Patch_V15.Patch: StitchVersionedCodable {
    public init(previousInstance: Patch_V15.PreviousInstance) {
