...
public enum Anchoring_V15: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V15
    public typealias PreviousInstance = Anchoring_V14.Anchoring
    // MARK: - endif
...
extension Anchoring_V15.Anchoring: StitchVersionedCodable {
    public init(previousInstance: Anchoring_V15.PreviousInstance) {
