...
public enum JSONCurveTo_V15: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V15
    public typealias PreviousInstance = JSONCurveTo_V14.JSONCurveTo
    // MARK: - endif
...
extension JSONCurveTo_V15.JSONCurveTo: StitchVersionedCodable {
    public init(previousInstance: JSONCurveTo_V15.PreviousInstance) {
