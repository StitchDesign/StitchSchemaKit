...
public enum JSONShapeCommand_V15: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V15
    public typealias PreviousInstance = JSONShapeCommand_V14.JSONShapeCommand
    public typealias JSONCurveTo = JSONCurveTo_V15.JSONCurveTo
    // MARK: - endif
...
extension JSONShapeCommand_V15.JSONShapeCommand: StitchVersionedCodable {
    public init(previousInstance: JSONShapeCommand_V15.PreviousInstance) {
        ...
        case .curveTo(let value):
            self = .curveTo(JSONShapeCommand_V15.JSONCurveTo(previousInstance: value))
        }
    }
}
