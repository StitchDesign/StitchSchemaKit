...
public enum JSONShapeKeys_V15: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V15
    public typealias PreviousInstance = JSONShapeKeys_V14.JSONShapeKeys
    // MARK: - endif
...
extension JSONShapeKeys_V15.JSONShapeKeys: StitchVersionedCodable {
    public init(previousInstance: JSONShapeKeys_V15.PreviousInstance) {
        fatalError()
    }
}
