...
public enum LayerSize_V15: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V15
    public typealias PreviousInstance = LayerSize_V14.LayerSize
    // MARK: - endif
...
extension LayerSize_V15.LayerSize: StitchVersionedCodable {
    public init(previousInstance: LayerSize_V15.PreviousInstance) {
