...
public enum PathPoint_V15: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V15
    public typealias PreviousInstance = PathPoint_V14.PathPoint
    // MARK: - endif
...
extension PathPoint_V15.PathPoint: StitchVersionedCodable {
    public init(previousInstance: PathPoint_V15.PreviousInstance) {
