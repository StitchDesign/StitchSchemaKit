...
public enum StitchJSON_V15: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V15
    public typealias PreviousInstance = StitchJSON_V14.StitchJSON
    // MARK: - endif
...
extension StitchJSON_V15.StitchJSON: StitchVersionedCodable {
    public init(previousInstance: StitchJSON_V15.PreviousInstance) {
