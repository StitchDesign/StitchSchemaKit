...
public enum PreviewSize_V15: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V15
    public typealias PreviousInstance = PreviewSize_V14.PreviewSize
    // MARK: - endif
...
extension PreviewSize_V15.PreviewSize: StitchVersionedCodable {
    public init(previousInstance: PreviewSize_V15.PreviousInstance) {
