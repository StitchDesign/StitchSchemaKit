...
public enum SplitterType_V15: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V15
    public typealias PreviousInstance = SplitterType_V14.SplitterType
    // MARK: - endif
...
extension SplitterType_V15.SplitterType: StitchVersionedCodable {
    public init(previousInstance: SplitterType_V15.PreviousInstance) {
