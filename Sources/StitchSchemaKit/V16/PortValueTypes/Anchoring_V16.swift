...
public enum Anchoring_V16: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V16
    public typealias PreviousInstance = Anchoring_V15.Anchoring
    // MARK: - endif
...
extension Anchoring_V16.Anchoring: StitchVersionedCodable {
    public init(previousInstance: Anchoring_V16.PreviousInstance) {
