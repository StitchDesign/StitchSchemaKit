...
public enum CustomShape_V16: StitchSchemaVersionable {
...
extension CustomShape_V16.CustomShape: StitchVersionedCodable {
    public init(previousInstance: CustomShape_V16.PreviousInstance) {
