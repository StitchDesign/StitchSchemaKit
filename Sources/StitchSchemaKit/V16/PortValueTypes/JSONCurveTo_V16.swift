...
public enum JSONCurveTo_V16: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V16
    public typealias PreviousInstance = JSONCurveTo_V15.JSONCurveTo
    // MARK: - endif
...
extension JSONCurveTo_V16.JSONCurveTo: StitchVersionedCodable {
    public init(previousInstance: JSONCurveTo_V16.PreviousInstance) {
