...
public enum JSONShapeCommand_V16: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V16
    public typealias PreviousInstance = JSONShapeCommand_V15.JSONShapeCommand
    public typealias JSONCurveTo = JSONCurveTo_V16.JSONCurveTo
    // MARK: - endif
...
extension JSONShapeCommand_V16.JSONShapeCommand: StitchVersionedCodable {
    public init(previousInstance: JSONShapeCommand_V16.PreviousInstance) {
        ...
        case .curveTo(let value):
            self = .curveTo(JSONShapeCommand_V16.JSONCurveTo(previousInstance: value))
        }
    }
}
