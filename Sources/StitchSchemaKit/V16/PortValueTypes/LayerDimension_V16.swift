...
public enum LayerDimension_V16: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V16
    public typealias PreviousInstance = LayerDimension_V15.LayerDimension
    // MARK: - endif
...
extension LayerDimension_V16.LayerDimension: StitchVersionedCodable {
    public init(previousInstance: LayerDimension_V16.PreviousInstance) {
