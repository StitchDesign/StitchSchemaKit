...
public enum LayerSize_V16: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V16
    public typealias PreviousInstance = LayerSize_V15.LayerSize
    // MARK: - endif
...
extension LayerSize_V16.LayerSize: StitchVersionedCodable {
    public init(previousInstance: LayerSize_V16.PreviousInstance) {
