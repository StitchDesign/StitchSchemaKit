...
public enum PathPoint_V16: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V16
    public typealias PreviousInstance = PathPoint_V15.PathPoint
    // MARK: - endif
...
extension PathPoint_V16.PathPoint: StitchVersionedCodable {
    public init(previousInstance: PathPoint_V16.PreviousInstance) {
