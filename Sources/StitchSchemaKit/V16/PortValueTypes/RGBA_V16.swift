...
public enum RGBA_V16: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V16
    public typealias PreviousInstance = RGBA_V15.RGBA
    // MARK: - endif
...
extension RGBA_V16.RGBA: StitchVersionedCodable {
    public init(previousInstance: RGBA_V16.PreviousInstance) {
