...
public enum ShapeAndRect_V16: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V16
    public typealias PreviousInstance = ShapeAndRect_V15.ShapeAndRect
...
extension ShapeAndRect_V16.ShapeAndRect: StitchVersionedCodable {
    public init(previousInstance: ShapeAndRect_V16.PreviousInstance) {
