...
public enum ShapeCommand_V16: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V16
    public typealias PreviousInstance = ShapeCommand_V15.ShapeCommand
    // MARK: - endif
...
extension ShapeCommand_V16.ShapeCommand: StitchVersionedCodable {
    public init(previousInstance: ShapeCommand_V16.PreviousInstance) {
...
extension ShapeCommand_V16.ShapeCommand: Codable {
