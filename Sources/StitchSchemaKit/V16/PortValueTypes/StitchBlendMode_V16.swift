...
public enum StitchBlendMode_V16: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V16
    public typealias PreviousInstance = StitchBlendMode_V15.StitchBlendMode
...
extension StitchBlendMode_V16.StitchBlendMode: StitchVersionedCodable {
    public init(previousInstance: StitchBlendMode_V16.PreviousInstance) {
