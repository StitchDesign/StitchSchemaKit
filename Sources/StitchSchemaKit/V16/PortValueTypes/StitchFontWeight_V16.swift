...
public enum StitchFontWeight_V16: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V16
    public typealias PreviousInstance = StitchFontWeight_V15.StitchFontWeight
    // MARK: - endif
...
extension StitchFontWeight_V16.StitchFontWeight: StitchVersionedCodable {
    public init(previousInstance: StitchFontWeight_V16.PreviousInstance) {
