...
public enum PreviewSize_V16: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V16
    public typealias PreviousInstance = PreviewSize_V15.PreviewSize
    // MARK: - endif
...
extension PreviewSize_V16.PreviewSize: StitchVersionedCodable {
    public init(previousInstance: PreviewSize_V16.PreviousInstance) {
