...
public enum CommentBoxData_V17: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V17
    public typealias PreviousInstance = CommentBoxData_V16.CommentBoxData
    // MARK: - endif
...
extension CommentBoxData_V17.CommentBoxData: StitchVersionedCodable {
    public init(previousInstance: CommentBoxData_V17.PreviousInstance) {
