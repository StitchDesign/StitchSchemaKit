...
public enum Patch_V17: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V17
    public typealias PreviousInstance = Patch_V16.Patch
    // MARK: - endif
...
extension Patch_V17.Patch: StitchVersionedCodable {
    public init(previousInstance: Patch_V17.PreviousInstance) {
