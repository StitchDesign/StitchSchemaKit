...
public enum JSONCurveTo_V17: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V17
    public typealias PreviousInstance = JSONCurveTo_V16.JSONCurveTo
    // MARK: - endif
...
extension JSONCurveTo_V17.JSONCurveTo: StitchVersionedCodable {
    public init(previousInstance: JSONCurveTo_V17.PreviousInstance) {
