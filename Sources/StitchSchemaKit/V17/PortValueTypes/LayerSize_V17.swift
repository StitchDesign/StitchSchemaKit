...
public enum LayerSize_V17: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V17
    public typealias PreviousInstance = LayerSize_V16.LayerSize
...
extension LayerSize_V17.LayerSize: StitchVersionedCodable {
    public init(previousInstance: LayerSize_V17.PreviousInstance) {
