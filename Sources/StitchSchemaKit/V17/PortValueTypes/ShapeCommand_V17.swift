...
public enum ShapeCommand_V17: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V17
    public typealias PreviousInstance = ShapeCommand_V16.ShapeCommand
    // MARK: - endif
...
extension ShapeCommand_V17.ShapeCommand: StitchVersionedCodable {
    public init(previousInstance: ShapeCommand_V17.PreviousInstance) {
...
extension ShapeCommand_V17.ShapeCommand: Codable {
