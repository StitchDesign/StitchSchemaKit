...
public enum StitchBlendMode_V17: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V17
    public typealias PreviousInstance = StitchBlendMode_V16.StitchBlendMode
...
extension StitchBlendMode_V17.StitchBlendMode: StitchVersionedCodable {
    public init(previousInstance: StitchBlendMode_V17.PreviousInstance) {
