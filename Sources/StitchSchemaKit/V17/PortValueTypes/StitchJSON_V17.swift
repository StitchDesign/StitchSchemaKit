...
public enum StitchJSON_V17: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V17
    public typealias PreviousInstance = StitchJSON_V16.StitchJSON
    // MARK: - endif
...
extension StitchJSON_V17.StitchJSON: StitchVersionedCodable {
    public init(previousInstance: StitchJSON_V17.PreviousInstance) {
