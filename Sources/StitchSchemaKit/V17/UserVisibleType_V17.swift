...
public enum UserVisibleType_V17: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V17
    public typealias PreviousInstance = UserVisibleType_V16.UserVisibleType
    // MARK: - endif
...
extension UserVisibleType_V17.UserVisibleType: StitchVersionedCodable {
    public init(previousInstance: UserVisibleType_V17.PreviousInstance) {
