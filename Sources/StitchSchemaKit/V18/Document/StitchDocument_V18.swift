...
public enum StitchDocument_V18: StitchSchemaVersionable {

    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V18
    public typealias PreviousInstance = StitchDocument_V17.StitchDocument
    public typealias NodeEntitySchemas = [NodeEntity_V18.NodeEntity]
    public typealias CommentBoxes = [CommentBoxData_V18.CommentBoxData]
    public typealias PreviewSize = PreviewSize_V18.PreviewSize
    public typealias SidebarLayerDataList = [SidebarLayerData_V18.SidebarLayerData]
    public typealias CameraSettings = CameraSettings_V18.CameraSettings
    // MARK: - end
...
extension StitchDocument_V18.StitchDocument {
    public init(previousInstance: StitchDocument_V18.PreviousInstance) {
        self.init(
            projectId: previousInstance.projectId,
            name: previousInstance.name,
            previewWindowSize: previousInstance.previewWindowSize,
            previewSizeDevice: PreviewSize_V18.PreviewSize(previousInstance: previousInstance.previewSizeDevice),
            ...
            nodes: StitchDocument_V18.NodeEntitySchemas(previousElements: previousInstance.nodes),
            orderedSidebarLayers: StitchDocument_V18.SidebarLayerDataList(previousElements: previousInstance.orderedSidebarLayers),
            commentBoxes: StitchDocument_V18.CommentBoxes(previousElements: previousInstance.commentBoxes),
            cameraSettings: StitchDocument_V18.CameraSettings(previousInstance: previousInstance.cameraSettings)
        )
    }
}
