...
public enum Layer_V18: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V18
    public typealias PreviousInstance = Layer_V17.Layer
    // MARK: - endif
...
extension Layer_V18.Layer: StitchVersionedCodable {
    public init(previousInstance: Layer_V18.PreviousInstance) {
