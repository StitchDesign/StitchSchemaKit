...
public enum LayerInputType_V18: StitchSchemaVersionable {
...
extension LayerInputType_V18.LayerInputType: StitchVersionedCodable {
    public init(previousInstance: LayerInputType_V18.PreviousInstance) {
