...
public enum Patch_V18: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V18
    public typealias PreviousInstance = Patch_V17.Patch
    // MARK: - endif
...
extension Patch_V18.Patch: StitchVersionedCodable {
    public init(previousInstance: Patch_V18.PreviousInstance) {
