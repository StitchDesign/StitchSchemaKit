...
public enum Anchoring_V18: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V18
    public typealias PreviousInstance = Anchoring_V17.Anchoring
    // MARK: - endif
...
extension Anchoring_V18.Anchoring: StitchVersionedCodable {
    public init(previousInstance: Anchoring_V18.PreviousInstance) {
