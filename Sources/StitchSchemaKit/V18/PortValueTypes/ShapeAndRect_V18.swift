...
public enum ShapeAndRect_V18: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V18
    public typealias PreviousInstance = ShapeAndRect_V17.ShapeAndRect
...
extension ShapeAndRect_V18.ShapeAndRect: StitchVersionedCodable {
    public init(previousInstance: ShapeAndRect_V18.PreviousInstance) {
