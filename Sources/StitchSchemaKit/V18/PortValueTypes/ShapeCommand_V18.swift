...
public enum ShapeCommand_V18: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V18
    public typealias PreviousInstance = ShapeCommand_V17.ShapeCommand
...
extension ShapeCommand_V18.ShapeCommand: StitchVersionedCodable {
    public init(previousInstance: ShapeCommand_V18.PreviousInstance) {
...
extension ShapeCommand_V18.ShapeCommand: Codable {
