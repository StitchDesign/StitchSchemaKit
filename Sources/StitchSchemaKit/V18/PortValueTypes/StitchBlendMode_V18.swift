...
public enum StitchBlendMode_V18: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V18
    public typealias PreviousInstance = StitchBlendMode_V17.StitchBlendMode
...
extension StitchBlendMode_V18.StitchBlendMode: StitchVersionedCodable {
    public init(previousInstance: StitchBlendMode_V18.PreviousInstance) {
