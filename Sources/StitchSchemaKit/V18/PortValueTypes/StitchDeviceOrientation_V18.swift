//
//  StitchDeviceOrientation_V18.swift
//  
//
...
extension StitchDeviceOrientation_V18.StitchDeviceOrientation: StitchVersionedCodable {
    public init(previousInstance: StitchDeviceOrientation_V18.PreviousInstance) {
