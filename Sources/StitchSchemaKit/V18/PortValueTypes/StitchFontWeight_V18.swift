...
public enum StitchFontWeight_V18: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V18
    public typealias PreviousInstance = StitchFontWeight_V17.StitchFontWeight
    // MARK: - endif
...
extension StitchFontWeight_V18.StitchFontWeight: StitchVersionedCodable {
    public init(previousInstance: StitchFontWeight_V18.PreviousInstance) {
