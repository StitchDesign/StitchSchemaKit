...
public enum StitchJSON_V18: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V18
    public typealias PreviousInstance = StitchJSON_V17.StitchJSON
    // MARK: - endif
...
extension StitchJSON_V18.StitchJSON: StitchVersionedCodable {
    public init(previousInstance: StitchJSON_V18.PreviousInstance) {
