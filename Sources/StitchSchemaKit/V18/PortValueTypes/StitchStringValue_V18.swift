...
public enum StitchStringValue_V18: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V18
    public typealias PreviousInstance = StitchStringValue_V17.StitchStringValue
    // MARK: - end
...
extension StitchStringValue_V18.StitchStringValue: StitchVersionedCodable {
    public init(previousInstance: StitchStringValue_V18.PreviousInstance) {
