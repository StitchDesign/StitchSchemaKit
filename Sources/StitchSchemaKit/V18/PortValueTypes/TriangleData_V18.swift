...
public enum TriangleData_V18: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V18
    public typealias PreviousInstance = TriangleData_V17.TriangleData
    // MARK: - endif
...
extension TriangleData_V18.TriangleData: StitchVersionedCodable {
    public init(previousInstance: TriangleData_V18.PreviousInstance) {
