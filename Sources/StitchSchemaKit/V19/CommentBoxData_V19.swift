...
public enum CommentBoxData_V19: StitchSchemaVersionable {
...
extension CommentBoxData_V19.CommentBoxData: StitchVersionedCodable {
    public init(previousInstance: CommentBoxData_V19.PreviousInstance) {
