...
public enum GroupNodeID_V19: StitchSchemaVersionable {
...
extension GroupNodeID_V19.GroupNodeId: StitchVersionedCodable {
    public init(previousInstance: GroupNodeID_V19.PreviousInstance) {
