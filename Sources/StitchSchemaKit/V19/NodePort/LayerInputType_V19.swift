...
public enum LayerInputType_V19: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V19
    public typealias PreviousInstance = LayerInputType_V18.LayerInputType
    // MARK: - endif
...
extension LayerInputType_V19.LayerInputType: StitchVersionedCodable {
    public init(previousInstance: LayerInputType_V19.PreviousInstance) {
