...
public enum Anchoring_V19: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V19
    public typealias PreviousInstance = Anchoring_V18.Anchoring
    // MARK: - endif
...
extension Anchoring_V19.Anchoring: StitchVersionedCodable {
    public init(previousInstance: Anchoring_V19.PreviousInstance) {
