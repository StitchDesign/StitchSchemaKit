...
public enum JSONCurveTo_V19: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V19
    public typealias PreviousInstance = JSONCurveTo_V18.JSONCurveTo
    // MARK: - endif
...
extension JSONCurveTo_V19.JSONCurveTo: StitchVersionedCodable {
    public init(previousInstance: JSONCurveTo_V19.PreviousInstance) {
