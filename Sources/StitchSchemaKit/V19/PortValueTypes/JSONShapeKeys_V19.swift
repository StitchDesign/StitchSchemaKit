...
public enum JSONShapeKeys_V19: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V19
    public typealias PreviousInstance = JSONShapeKeys_V18.JSONShapeKeys
    // MARK: - endif
...
extension JSONShapeKeys_V19.JSONShapeKeys: StitchVersionedCodable {
    public init(previousInstance: JSONShapeKeys_V19.PreviousInstance) {
        fatalError()
    }
}
