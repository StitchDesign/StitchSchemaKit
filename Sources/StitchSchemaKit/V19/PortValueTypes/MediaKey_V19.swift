...
public enum MediaKey_V19: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V19
    public typealias PreviousInstance = MediaKey_V18.MediaKey
    // MARK: - endif
...
extension MediaKey_V19.MediaKey: StitchVersionedCodable {
    public init(previousInstance: MediaKey_V19.PreviousInstance) {
