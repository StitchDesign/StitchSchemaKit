...
public enum PathPoint_V19: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V19
    public typealias PreviousInstance = PathPoint_V18.PathPoint
    // MARK: - endif
...
extension PathPoint_V19.PathPoint: StitchVersionedCodable {
    public init(previousInstance: PathPoint_V19.PreviousInstance) {
