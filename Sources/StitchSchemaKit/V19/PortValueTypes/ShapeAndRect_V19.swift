...
public enum ShapeAndRect_V19: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V19
    public typealias PreviousInstance = ShapeAndRect_V18.ShapeAndRect
...
extension ShapeAndRect_V19.ShapeAndRect: StitchVersionedCodable {
    public init(previousInstance: ShapeAndRect_V19.PreviousInstance) {
