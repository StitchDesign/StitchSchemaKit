...
public enum ShapeCommand_V19: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V19
    public typealias PreviousInstance = ShapeCommand_V18.ShapeCommand
...
extension ShapeCommand_V19.ShapeCommand: StitchVersionedCodable {
    public init(previousInstance: ShapeCommand_V19.PreviousInstance) {
...
extension ShapeCommand_V19.ShapeCommand: Codable {
