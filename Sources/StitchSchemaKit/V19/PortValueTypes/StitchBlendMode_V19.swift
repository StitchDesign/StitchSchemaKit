...
public enum StitchBlendMode_V19: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V19
    public typealias PreviousInstance = StitchBlendMode_V18.StitchBlendMode
...
extension StitchBlendMode_V19.StitchBlendMode: StitchVersionedCodable {
    public init(previousInstance: StitchBlendMode_V19.PreviousInstance) {
