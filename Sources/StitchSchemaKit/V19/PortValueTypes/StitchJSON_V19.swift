...
public enum StitchJSON_V19: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V19
    public typealias PreviousInstance = StitchJSON_V18.StitchJSON
    // MARK: - endif
...
extension StitchJSON_V19.StitchJSON: StitchVersionedCodable {
    public init(previousInstance: StitchJSON_V19.PreviousInstance) {
