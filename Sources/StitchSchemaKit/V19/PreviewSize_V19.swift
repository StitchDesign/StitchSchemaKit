...
public enum PreviewSize_V19: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V19
    public typealias PreviousInstance = PreviewSize_V18.PreviewSize
    // MARK: - endif
...
extension PreviewSize_V19.PreviewSize: StitchVersionedCodable {
    public init(previousInstance: PreviewSize_V19.PreviousInstance) {
