...
public enum StitchDocument_V2: StitchSchemaVersionable {
    ...
    public typealias SidebarLayerTypes = [SidebarLayerType_V2.SidebarLayerType]
...
extension StitchDocument_V2.StitchDocument {
    public init(previousInstance: StitchDocument_V2.PreviousInstance) {
        self.init(
            ...
            orderedSidebarLayers: StitchDocument_V2.SidebarLayerTypes(previousElements: previousInstance.orderedSidebarLayers),
