...
public enum LayerTextDecoration_V2: StitchSchemaVersionable {
...
extension LayerTextDecoration_V2.LayerTextDecoration: StitchVersionedCodable {
    public init(previousInstance: LayerTextDecoration_V2.PreviousInstance) {
