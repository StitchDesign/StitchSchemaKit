...
public enum TriangleData_V2: StitchSchemaVersionable {
...
extension TriangleData_V2.TriangleData: StitchVersionedCodable {
    public init(previousInstance: TriangleData_V2.PreviousInstance) {
