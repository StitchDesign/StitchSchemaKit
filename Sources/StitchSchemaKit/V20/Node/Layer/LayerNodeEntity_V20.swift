...
public enum LayerNodeEntity_V20: StitchSchemaVersionable {

    // MARK: - ensure versions are correct
    static var version = StitchSchemaVersion._V20
    public typealias PreviousInstance = LayerNodeEntity_V19.LayerNodeEntity
    public typealias NodeEntitySchema = NodeEntity_V20
    public typealias Layer = Layer_V20.Layer
    public typealias NodeConnectionType = NodeConnectionType_V20.NodeConnectionType
    // MARK: - end
    ...
    public struct LayerNodeEntity: Equatable {
        ...
        public var sizingScenarioPort: NodeConnectionType
        ...
        public init(id: UUID,
                    ...
                    sizingScenarioPort: NodeConnectionType,
...
extension LayerNodeEntity_V20.LayerNodeEntity: StitchVersionedCodable {
    public init(previousInstance: LayerNodeEntity_V20.PreviousInstance) {
                
        self.init(id: previousInstance.id,
                  layer: LayerNodeEntity_V20.Layer(previousInstance: previousInstance.layer),
                  positionPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.positionPort),
                  sizePort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.sizePort),
                  scalePort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.scalePort),
                  anchoringPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.anchoringPort),
                  opacityPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.opacityPort),
                  zIndexPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.zIndexPort),
                  masksPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.masksPort),
                  colorPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.colorPort),
                  
                  rotationXPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.rotationXPort),
                  rotationYPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.rotationYPort),
                  rotationZPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.rotationZPort),
                  
                  lineColorPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.lineColorPort),
                  lineWidthPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.lineWidthPort),
                  blurPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.blurPort),
                  blendModePort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.blendModePort),
                  brightnessPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.brightnessPort),
                  colorInvertPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.colorInvertPort),
                  contrastPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.contrastPort),
                  hueRotationPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.hueRotationPort),
                  saturationPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.saturationPort),
                  pivotPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.pivotPort),
                  enabledPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.enabledPort),
                  blurRadiusPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.blurRadiusPort),
                  backgroundColorPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.backgroundColorPort),
                  isClippedPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.isClippedPort),
                  orientationPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.orientationPort),
                  
                  // Converting `paddingPort` from `PortValue.point4D` to `PortValue.padding`:
                  paddingPort: .values((previousInstance.paddingPort.getValues ?? [])
                    .map({ portValue in
                        switch portValue {
                        case .point4D(let x):
                            return .padding(.init(top: x.x,
                                                  right: x.y,
                                                  bottom: x.z,
                                                  left: x.w))
                        default:
                  ...
                  setupModePort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.setupModePort),
                  allAnchorsPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.allAnchorsPort),
                  cameraDirectionPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.cameraDirectionPort),
                  isCameraEnabledPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.isCameraEnabledPort),
                  isShadowsEnabledPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.isShadowsEnabledPort),
                  
                  shapePort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.shapePort),
                  strokePositionPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.strokePositionPort),
                  strokeWidthPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.strokeWidthPort),
                  strokeColorPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.strokeColorPort),
                  strokeStartPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.strokeStartPort),
                  strokeEndPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.strokeEndPort),
                  strokeLineCapPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.strokeLineCapPort),
                  strokeLineJoinPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.strokeLineJoinPort),
                  coordinateSystemPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.coordinateSystemPort),
                  
                  cornerRadiusPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.cornerRadiusPort),
                  canvasLineColorPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.canvasLineColorPort),
                  canvasLineWidthPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.canvasLineWidthPort),
                  canvasPositionPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.canvasPositionPort),
                  textPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.textPort),
                  fontSizePort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.fontSizePort),
                                    
                  textAlignmentPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.textAlignmentPort),
                  verticalAlignmentPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.verticalAlignmentPort),
                  textDecorationPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.textDecorationPort),
                  textFontPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.textFontPort),
                  
                  imagePort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.imagePort),
                  videoPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.videoPort),
                  fitStylePort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.fitStylePort),
                  clippedPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.clippedPort),
                  isAnimatingPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.isAnimatingPort),
                  progressIndicatorStylePort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.progressIndicatorStylePort),
                  progressPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.progressPort),
                  model3DPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.model3DPort),
                  mapTypePort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.mapTypePort),
                  mapLatLongPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.mapLatLongPort),
                  mapSpanPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.mapSpanPort),
                  isSwitchToggledPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.isSwitchToggledPort),
                  placeholderTextPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.placeholderTextPort),
                  startColorPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.startColorPort),
                  endColorPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.endColorPort),
                  startAnchorPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.startAnchorPort),
                  endAnchorPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.endAnchorPort),
                  centerAnchorPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.centerAnchorPort),
                  startAnglePort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.startAnglePort),
                  endAnglePort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.endAnglePort),
                  startRadiusPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.startRadiusPort),
                  endRadiusPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.endRadiusPort),
                  
                  shadowColorPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.shadowColorPort),
                  shadowOpacityPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.shadowOpacityPort),
                  shadowRadiusPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.shadowRadiusPort),
                  shadowOffsetPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.shadowOffsetPort),
                  
                  sfSymbolPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.sfSymbolPort),
                  
                  videoURLPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.videoURLPort),
                  volumePort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.volumePort),

                  spacingBetweenGridColumnsPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.spacingBetweenGridColumnsPort),
                  spacingBetweenGridRowsPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.spacingBetweenGridRowsPort),
                  itemAlignmentWithinGridCellPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.itemAlignmentWithinGridCellPort),

                  sizingScenarioPort: NodeConnectionType_V20.NodeConnectionType.values([]),
                  
                  widthAxisPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.widthAxisPort),
                  heightAxisPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.heightAxisPort),
                  contentModePort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.contentModePort),
                  minSizePort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.minSizePort),
                  maxSizePort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.maxSizePort),
                  spacingPort: NodeConnectionType_V20.NodeConnectionType(previousInstance: previousInstance.spacingPort),
