...
public enum Patch_V20: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V20
    public typealias PreviousInstance = Patch_V19.Patch
    // MARK: - endif
...
extension Patch_V20.Patch: StitchVersionedCodable {
    public init(previousInstance: Patch_V20.PreviousInstance) {
