...
public enum CustomShape_V20: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V20
    public typealias PreviousInstance = CustomShape_V19.CustomShape
    // MARK: - endif
...
extension CustomShape_V20.CustomShape: StitchVersionedCodable {
    public init(previousInstance: CustomShape_V20.PreviousInstance) {
