...
public enum StitchBlendMode_V20: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V20
    public typealias PreviousInstance = StitchBlendMode_V19.StitchBlendMode
...
extension StitchBlendMode_V20.StitchBlendMode: StitchVersionedCodable {
    public init(previousInstance: StitchBlendMode_V20.PreviousInstance) {
