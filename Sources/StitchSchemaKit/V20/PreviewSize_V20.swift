...
public enum PreviewSize_V20: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V20
    public typealias PreviousInstance = PreviewSize_V19.PreviewSize
    // MARK: - endif
...
extension PreviewSize_V20.PreviewSize: StitchVersionedCodable {
    public init(previousInstance: PreviewSize_V20.PreviousInstance) {
