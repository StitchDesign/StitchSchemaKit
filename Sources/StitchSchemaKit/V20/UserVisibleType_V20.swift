...
public enum UserVisibleType_V20: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V20
    public typealias PreviousInstance = UserVisibleType_V19.UserVisibleType
    // MARK: - endif
...
extension UserVisibleType_V20.UserVisibleType: StitchVersionedCodable {
    public init(previousInstance: UserVisibleType_V20.PreviousInstance) {
