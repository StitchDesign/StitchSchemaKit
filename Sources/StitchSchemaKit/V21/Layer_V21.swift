...
public enum Layer_V21: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V21
    public typealias PreviousInstance = Layer_V20.Layer
    // MARK: - endif
...
extension Layer_V21.Layer: StitchVersionedCodable {
    public init(previousInstance: Layer_V21.PreviousInstance) {
