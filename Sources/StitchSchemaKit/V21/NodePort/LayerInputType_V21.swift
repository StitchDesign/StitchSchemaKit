...
public enum LayerInputType_V21: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V21
    public typealias PreviousInstance = LayerInputType_V20.LayerInputType
    // MARK: - endif
...
extension LayerInputType_V21.LayerInputType: StitchVersionedCodable {
    public init(previousInstance: LayerInputType_V21.PreviousInstance) {
