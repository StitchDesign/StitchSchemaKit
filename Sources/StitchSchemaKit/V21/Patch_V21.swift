...
public enum Patch_V21: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V21
    public typealias PreviousInstance = Patch_V20.Patch
    // MARK: - endif
...
extension Patch_V21.Patch: StitchVersionedCodable {
    public init(previousInstance: Patch_V21.PreviousInstance) {
