...
public enum Anchoring_V21: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V21
    public typealias PreviousInstance = Anchoring_V20.Anchoring
    // MARK: - endif
...
extension Anchoring_V21.Anchoring: StitchVersionedCodable {
    public init(previousInstance: Anchoring_V21.PreviousInstance) {
