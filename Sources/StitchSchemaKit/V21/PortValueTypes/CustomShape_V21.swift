...
public enum CustomShape_V21: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V21
    public typealias PreviousInstance = CustomShape_V20.CustomShape
...
extension CustomShape_V21.CustomShape: StitchVersionedCodable {
    public init(previousInstance: CustomShape_V21.PreviousInstance) {
