...
public enum PathPoint_V21: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V21
    public typealias PreviousInstance = PathPoint_V20.PathPoint
    // MARK: - endif
...
extension PathPoint_V21.PathPoint: StitchVersionedCodable {
    public init(previousInstance: PathPoint_V21.PreviousInstance) {
