...
extension ShapeCommand_V21.ShapeCommand: StitchVersionedCodable {
    public init(previousInstance: ShapeCommand_V21.PreviousInstance) {
...
extension ShapeCommand_V21.ShapeCommand: Codable {
