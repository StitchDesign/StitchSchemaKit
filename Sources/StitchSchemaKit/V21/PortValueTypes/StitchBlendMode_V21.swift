...
public enum StitchBlendMode_V21: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V21
    public typealias PreviousInstance = StitchBlendMode_V20.StitchBlendMode
...
extension StitchBlendMode_V21.StitchBlendMode: StitchVersionedCodable {
    public init(previousInstance: StitchBlendMode_V21.PreviousInstance) {
