...
public enum StitchFontWeight_V21: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V21
    public typealias PreviousInstance = StitchFontWeight_V20.StitchFontWeight
    // MARK: - endif
...
extension StitchFontWeight_V21.StitchFontWeight: StitchVersionedCodable {
    public init(previousInstance: StitchFontWeight_V21.PreviousInstance) {
