...
public enum StitchStringValue_V21: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V21
    public typealias PreviousInstance = StitchStringValue_V20.StitchStringValue
    // MARK: - end
...
extension StitchStringValue_V21.StitchStringValue: StitchVersionedCodable {
    public init(previousInstance: StitchStringValue_V21.PreviousInstance) {
