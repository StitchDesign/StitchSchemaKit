...
public enum UserVisibleType_V21: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V21
    public typealias PreviousInstance = UserVisibleType_V20.UserVisibleType
    // MARK: - endif
...
extension UserVisibleType_V21.UserVisibleType: StitchVersionedCodable {
    public init(previousInstance: UserVisibleType_V21.PreviousInstance) {
