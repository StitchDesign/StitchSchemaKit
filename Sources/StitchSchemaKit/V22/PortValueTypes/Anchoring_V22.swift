...
public enum Anchoring_V22: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V22
    public typealias PreviousInstance = Anchoring_V21.Anchoring
    // MARK: - endif
...
extension Anchoring_V22.Anchoring: StitchVersionedCodable {
    public init(previousInstance: Anchoring_V22.PreviousInstance) {
