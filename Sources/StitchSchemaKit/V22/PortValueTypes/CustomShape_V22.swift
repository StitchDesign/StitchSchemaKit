...
public enum CustomShape_V22: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V22
    public typealias PreviousInstance = CustomShape_V21.CustomShape
...
extension CustomShape_V22.CustomShape: StitchVersionedCodable {
    public init(previousInstance: CustomShape_V22.PreviousInstance) {
