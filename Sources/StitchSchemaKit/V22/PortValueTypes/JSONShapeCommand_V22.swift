...
public enum JSONShapeCommand_V22: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V22
    public typealias PreviousInstance = JSONShapeCommand_V21.JSONShapeCommand
    public typealias JSONCurveTo = JSONCurveTo_V22.JSONCurveTo
    // MARK: - endif
...
extension JSONShapeCommand_V22.JSONShapeCommand: StitchVersionedCodable {
    public init(previousInstance: JSONShapeCommand_V22.PreviousInstance) {
        ...
        case .curveTo(let value):
            self = .curveTo(JSONShapeCommand_V22.JSONCurveTo(previousInstance: value))
        }
    }
}
