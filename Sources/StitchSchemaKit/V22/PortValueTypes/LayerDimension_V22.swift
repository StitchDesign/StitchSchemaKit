...
public enum LayerDimension_V22: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V22
    public typealias PreviousInstance = LayerDimension_V21.LayerDimension
    // MARK: - endif
...
extension LayerDimension_V22.LayerDimension: StitchVersionedCodable {
    public init(previousInstance: LayerDimension_V22.PreviousInstance) {
