...
public enum PathPoint_V22: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V22
    public typealias PreviousInstance = PathPoint_V21.PathPoint
    // MARK: - endif
...
extension PathPoint_V22.PathPoint: StitchVersionedCodable {
    public init(previousInstance: PathPoint_V22.PreviousInstance) {
