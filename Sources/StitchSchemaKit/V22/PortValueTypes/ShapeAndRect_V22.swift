...
public enum ShapeAndRect_V22: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V22
    public typealias PreviousInstance = ShapeAndRect_V21.ShapeAndRect
...
extension ShapeAndRect_V22.ShapeAndRect: StitchVersionedCodable {
    public init(previousInstance: ShapeAndRect_V22.PreviousInstance) {
