...
public enum ShapeCommand_V22: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V22
    public typealias PreviousInstance = ShapeCommand_V21.ShapeCommand
...
extension ShapeCommand_V22.ShapeCommand: StitchVersionedCodable {
    public init(previousInstance: ShapeCommand_V22.PreviousInstance) {
...
extension ShapeCommand_V22.ShapeCommand: Codable {
