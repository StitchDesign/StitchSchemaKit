...
public enum StitchBlendMode_V22: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V22
    public typealias PreviousInstance = StitchBlendMode_V21.StitchBlendMode
...
extension StitchBlendMode_V22.StitchBlendMode: StitchVersionedCodable {
    public init(previousInstance: StitchBlendMode_V22.PreviousInstance) {
