...
public enum StitchFontWeight_V22: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V22
    public typealias PreviousInstance = StitchFontWeight_V21.StitchFontWeight
    // MARK: - endif
...
extension StitchFontWeight_V22.StitchFontWeight: StitchVersionedCodable {
    public init(previousInstance: StitchFontWeight_V22.PreviousInstance) {
