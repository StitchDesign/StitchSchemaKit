...
public enum StitchStringValue_V22: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static let version = StitchSchemaVersion._V22
    public typealias PreviousInstance = StitchStringValue_V21.StitchStringValue
    // MARK: - end
...
extension StitchStringValue_V22.StitchStringValue: StitchVersionedCodable {
    public init(previousInstance: StitchStringValue_V22.PreviousInstance) {
