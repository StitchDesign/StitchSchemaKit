...
public enum TriangleData_V22: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V22
    public typealias PreviousInstance = TriangleData_V21.TriangleData
    // MARK: - endif
...
extension TriangleData_V22.TriangleData: StitchVersionedCodable {
    public init(previousInstance: TriangleData_V22.PreviousInstance) {
