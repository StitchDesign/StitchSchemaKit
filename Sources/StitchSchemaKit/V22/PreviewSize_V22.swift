...
public enum PreviewSize_V22: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V22
    public typealias PreviousInstance = PreviewSize_V21.PreviewSize
    // MARK: - endif
...
extension PreviewSize_V22.PreviewSize: StitchVersionedCodable {
    public init(previousInstance: PreviewSize_V22.PreviousInstance) {
