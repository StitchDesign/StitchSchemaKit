...
extension NodeEntity_V23.NodeEntity {
    var patchNode: PatchNodeEntity_V23.PatchNodeEntity? {
    ...
    mutating func inputsMutator(_ callback: (NodeConnectionType_V23.NodeConnectionType) -> NodeConnectionType_V23.NodeConnectionType) {
        switch self.nodeTypeEntity {
