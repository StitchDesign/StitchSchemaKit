...
public enum Layer_V23: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V23
    public typealias PreviousInstance = Layer_V22.Layer
    // MARK: - endif
...
extension Layer_V23.Layer: StitchVersionedCodable {
    public init(previousInstance: Layer_V23.PreviousInstance) {
