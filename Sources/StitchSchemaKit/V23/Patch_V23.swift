...
public enum Patch_V23: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V23
    public typealias PreviousInstance = Patch_V22.Patch
    // MARK: - endif
...
extension Patch_V23.Patch: StitchVersionedCodable {
    public init(previousInstance: Patch_V23.PreviousInstance) {
