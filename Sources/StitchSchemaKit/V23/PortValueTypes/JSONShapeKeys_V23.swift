...
public enum JSONShapeKeys_V23: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V23
    public typealias PreviousInstance = JSONShapeKeys_V22.JSONShapeKeys
    // MARK: - endif
...
extension JSONShapeKeys_V23.JSONShapeKeys: StitchVersionedCodable {
    public init(previousInstance: JSONShapeKeys_V23.PreviousInstance) {
        fatalError()
    }
}
