...
public enum LayerDimension_V23: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V23
    public typealias PreviousInstance = LayerDimension_V22.LayerDimension
    // MARK: - endif
...
extension LayerDimension_V23.LayerDimension: StitchVersionedCodable {
    public init(previousInstance: LayerDimension_V23.PreviousInstance) {
