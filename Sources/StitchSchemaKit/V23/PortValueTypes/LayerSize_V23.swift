...
public enum LayerSize_V23: StitchSchemaVersionable {
...
extension LayerSize_V23.LayerSize: StitchVersionedCodable {
    public init(previousInstance: LayerSize_V23.PreviousInstance) {
