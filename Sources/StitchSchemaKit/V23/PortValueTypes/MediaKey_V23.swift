...
public enum MediaKey_V23: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V23
    public typealias PreviousInstance = MediaKey_V22.MediaKey
    // MARK: - endif
...
extension MediaKey_V23.MediaKey: StitchVersionedCodable {
    public init(previousInstance: MediaKey_V23.PreviousInstance) {
