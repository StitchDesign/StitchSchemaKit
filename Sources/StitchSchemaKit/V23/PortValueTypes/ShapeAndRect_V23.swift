...
public enum ShapeAndRect_V23: StitchSchemaVersionable {
    ...
    public typealias RoundedRectangleData = RoundedRectangleData_V23.RoundedRectangleData
    public typealias TriangleData = TriangleData_V23.TriangleData
    public typealias JSONShapeCommands = [JSONShapeCommand_V23.JSONShapeCommand]
    // MARK: - endif
...
extension ShapeAndRect_V23.ShapeAndRect {
...
extension ShapeAndRect_V23.ShapeAndRect: StitchVersionedCodable {
    public init(previousInstance: ShapeAndRect_V23.PreviousInstance) {
