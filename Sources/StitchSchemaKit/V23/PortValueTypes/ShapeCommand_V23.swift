...
public enum ShapeCommand_V23: StitchSchemaVersionable {
...
extension ShapeCommand_V23.ShapeCommand: StitchVersionedCodable {
    public init(previousInstance: ShapeCommand_V23.PreviousInstance) {
...
extension ShapeCommand_V23.ShapeCommand: Codable {
