...
public enum StitchBlendMode_V23: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V23
    public typealias PreviousInstance = StitchBlendMode_V22.StitchBlendMode
...
extension StitchBlendMode_V23.StitchBlendMode: StitchVersionedCodable {
    public init(previousInstance: StitchBlendMode_V23.PreviousInstance) {
