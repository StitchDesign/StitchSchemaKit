...
public enum UserVisibleType_V23: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V23
    public typealias PreviousInstance = UserVisibleType_V22.UserVisibleType
    // MARK: - endif
...
extension UserVisibleType_V23.UserVisibleType: StitchVersionedCodable {
    public init(previousInstance: UserVisibleType_V23.PreviousInstance) {
