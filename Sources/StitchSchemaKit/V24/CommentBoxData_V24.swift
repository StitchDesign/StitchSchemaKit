...
public enum CommentBoxData_V24: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V24
    public typealias PreviousInstance = CommentBoxData_V23.CommentBoxData
    public typealias CanvasItemId = CanvasItemId_V24.CanvasItemId
    // MARK: - endif
...
extension CommentBoxData_V24.CommentBoxData: StitchVersionedCodable {
    public init(previousInstance: CommentBoxData_V24.PreviousInstance) {
