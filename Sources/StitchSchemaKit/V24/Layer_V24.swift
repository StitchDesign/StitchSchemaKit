...
public enum Layer_V24: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V24
    public typealias PreviousInstance = Layer_V23.Layer
    // MARK: - endif
...
extension Layer_V24.Layer: StitchVersionedCodable {
    public init(previousInstance: Layer_V24.PreviousInstance) {
