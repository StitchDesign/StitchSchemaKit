...
public enum LayerNodeEntity_V24: StitchSchemaVersionable {

    // MARK: - ensure versions are correct
    static var version = StitchSchemaVersion._V24
    public typealias PreviousInstance = LayerNodeEntity_V23.LayerNodeEntity
    public typealias CanvasNodeEntity = CanvasNodeEntity_V24.CanvasNodeEntity
    public typealias Layer = Layer_V24.Layer
    public typealias LayerInputEntity = LayerInputEntity_V24.LayerInputEntity
...
extension LayerNodeEntity_V24.LayerNodeEntity: StitchVersionedCodable {
    public init(previousInstance: LayerNodeEntity_V24.PreviousInstance) {
        self.init(id: previousInstance.id,
                  layer: LayerNodeEntity_V24.Layer(previousInstance: previousInstance.layer),
                  ...
                  // `sizePort:` needs to be a LayerInputEntity_V24
                  // I have a LayerNodeEntity_V23
                  
                  sizePort: LayerNodeEntity_V24.LayerInputEntity.init(previousInstance: previousInstance.sizePort),
