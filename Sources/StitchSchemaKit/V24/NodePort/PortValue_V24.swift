...
public enum PortValue_V24: StitchSchemaVersionable {
    ...
    public typealias LayerNodeId = LayerNodeId_V24.LayerNodeId
    public typealias TextTransform = TextTransform_V24.TextTransform
    public typealias StitchTransform = StitchTransform_V24.StitchTransform
    // MARK: - end
