...
public enum Patch_V24: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V24
    public typealias PreviousInstance = Patch_V23.Patch
    // MARK: - endif
...
extension Patch_V24.Patch: StitchVersionedCodable {
    public init(previousInstance: Patch_V24.PreviousInstance) {
