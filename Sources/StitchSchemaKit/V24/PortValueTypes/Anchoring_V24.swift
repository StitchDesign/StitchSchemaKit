...
public enum Anchoring_V24: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V24
    public typealias PreviousInstance = Anchoring_V23.Anchoring
    // MARK: - endif
...
extension Anchoring_V24.Anchoring: StitchVersionedCodable {
    public init(previousInstance: Anchoring_V24.PreviousInstance) {
