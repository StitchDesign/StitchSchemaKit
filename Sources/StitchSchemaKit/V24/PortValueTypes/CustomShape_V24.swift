...
public enum CustomShape_V24: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V24
    public typealias PreviousInstance = CustomShape_V23.CustomShape
    public typealias ShapeAndRect = ShapeAndRect_V24.ShapeAndRect
...
extension CustomShape_V24.CustomShape: StitchVersionedCodable {
    public init(previousInstance: CustomShape_V24.PreviousInstance) {
