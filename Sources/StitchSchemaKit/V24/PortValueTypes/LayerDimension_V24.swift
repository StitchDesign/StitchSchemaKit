...
public enum LayerDimension_V24: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V24
    public typealias PreviousInstance = LayerDimension_V23.LayerDimension
    // MARK: - endif
...
extension LayerDimension_V24.LayerDimension: StitchVersionedCodable {
    public init(previousInstance: LayerDimension_V24.PreviousInstance) {
