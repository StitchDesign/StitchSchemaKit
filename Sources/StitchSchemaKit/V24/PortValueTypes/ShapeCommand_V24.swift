...
public enum ShapeCommand_V24: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V24
    public typealias PreviousInstance = ShapeCommand_V23.ShapeCommand
    public typealias PathPoint = PathPoint_V24.PathPoint
    // MARK: - endif
...
extension ShapeCommand_V24.ShapeCommand: StitchVersionedCodable {
    public init(previousInstance: ShapeCommand_V24.PreviousInstance) {
...
extension ShapeCommand_V24.ShapeCommand: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        case .lineTo:
            let point = try container.decode(PathPoint_V24.PathPoint.self, forKey: .point)
        ...
        case .curveTo:
            ...
            let curveFrom = try container.decode(PathPoint_V24.PathPoint.self, forKey: .curveFrom)
            let curveTo = try container.decode(PathPoint_V24.PathPoint.self, forKey: .curveTo)
