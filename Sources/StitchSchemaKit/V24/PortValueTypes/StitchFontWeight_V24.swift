...
public enum StitchFontWeight_V24: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V24
    public typealias PreviousInstance = StitchFontWeight_V23.StitchFontWeight
    // MARK: - endif
...
extension StitchFontWeight_V24.StitchFontWeight: StitchVersionedCodable {
    public init(previousInstance: StitchFontWeight_V24.PreviousInstance) {
