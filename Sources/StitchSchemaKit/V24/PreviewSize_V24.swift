...
public enum PreviewSize_V24: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V24
    public typealias PreviousInstance = PreviewSize_V23.PreviewSize
    // MARK: - endif
...
extension PreviewSize_V24.PreviewSize: StitchVersionedCodable {
    public init(previousInstance: PreviewSize_V24.PreviousInstance) {
