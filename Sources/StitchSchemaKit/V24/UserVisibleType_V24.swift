...
public enum UserVisibleType_V24: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V24
    public typealias PreviousInstance = UserVisibleType_V23.UserVisibleType
    // MARK: - endif
...
extension UserVisibleType_V24.UserVisibleType: StitchVersionedCodable {
    public init(previousInstance: UserVisibleType_V24.PreviousInstance) {
