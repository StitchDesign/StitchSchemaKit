...
public enum CommentBoxData_V25: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V25
    public typealias PreviousInstance = CommentBoxData_V24.CommentBoxData
...
extension CommentBoxData_V25.CommentBoxData: StitchVersionedCodable {
    public init(previousInstance: CommentBoxData_V25.PreviousInstance) {
