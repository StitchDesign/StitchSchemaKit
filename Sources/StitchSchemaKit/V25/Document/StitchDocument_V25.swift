...
public enum StitchDocument_V25: StitchSchemaVersionable {
    ...
    public typealias NodeEntitySchemas = [NodeEntity_V25.NodeEntity]
    public typealias CommentBoxes = [CommentBoxData_V25.CommentBoxData]
    public typealias PreviewSize = PreviewSize_V25.PreviewSize
    public typealias SidebarLayerDataList = [SidebarLayerData_V25.SidebarLayerData]
...
extension StitchDocument_V25.StitchDocument {
    public init(previousInstance: StitchDocument_V25.PreviousInstance) {
        self.init(
            ...
            previewSizeDevice: PreviewSize_V25.PreviewSize(previousInstance: previousInstance.previewSizeDevice),
            ...
            nodes: StitchDocument_V25.NodeEntitySchemas(previousElements: previousInstance.nodes),
            orderedSidebarLayers: StitchDocument_V25.SidebarLayerDataList(previousElements: previousInstance.orderedSidebarLayers),
            commentBoxes: StitchDocument_V25.CommentBoxes(previousElements: previousInstance.commentBoxes),
            cameraSettings: StitchDocument_V25.CameraSettings(previousInstance: previousInstance.cameraSettings)
        )
    }
}
