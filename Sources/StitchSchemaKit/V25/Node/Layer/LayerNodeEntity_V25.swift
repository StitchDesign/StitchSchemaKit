...
public enum LayerNodeEntity_V25: StitchSchemaVersionable {

    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V25
    public typealias PreviousInstance = LayerNodeEntity_V24.LayerNodeEntity
    public typealias CanvasNodeEntity = CanvasNodeEntity_V25.CanvasNodeEntity
    public typealias Layer = Layer_V25.Layer
    public typealias LayerInputEntity = LayerInputEntity_V25.LayerInputEntity
...
extension LayerNodeEntity_V25.LayerNodeEntity: StitchVersionedCodable {
    public init(previousInstance: LayerNodeEntity_V25.PreviousInstance) {
        self.init(id: previousInstance.id,
                  layer: LayerNodeEntity_V25.Layer(previousInstance: previousInstance.layer),
                  ...
                  // `sizePort:` needs to be a LayerInputEntity_V25
                  // I have a LayerNodeEntity_V24
                  
                  sizePort: LayerNodeEntity_V25.LayerInputEntity.init(previousInstance: previousInstance.sizePort),
