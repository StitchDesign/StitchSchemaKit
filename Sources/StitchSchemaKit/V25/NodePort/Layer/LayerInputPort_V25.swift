...
public enum LayerInputPort_V25: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V25
    public typealias PreviousInstance = LayerInputPort_V24.LayerInputPort
    // MARK: - endif
...
extension LayerInputPort_V25.LayerInputPort: StitchVersionedCodable {
    public init(previousInstance: LayerInputPort_V25.PreviousInstance) {
