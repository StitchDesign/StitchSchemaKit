...
public enum Patch_V25: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V25
    public typealias PreviousInstance = Patch_V24.Patch
    // MARK: - endif
...
extension Patch_V25.Patch: StitchVersionedCodable {
    public init(previousInstance: Patch_V25.PreviousInstance) {
