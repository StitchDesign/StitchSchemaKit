...
public enum Anchoring_V25: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V25
    public typealias PreviousInstance = Anchoring_V24.Anchoring
    // MARK: - endif
...
extension Anchoring_V25.Anchoring: StitchVersionedCodable {
    public init(previousInstance: Anchoring_V25.PreviousInstance) {
