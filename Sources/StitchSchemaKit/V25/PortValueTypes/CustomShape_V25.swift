...
public enum CustomShape_V25: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V25
    public typealias PreviousInstance = CustomShape_V24.CustomShape
    public typealias ShapeAndRect = ShapeAndRect_V25.ShapeAndRect
...
extension CustomShape_V25.CustomShape: StitchVersionedCodable {
    public init(previousInstance: CustomShape_V25.PreviousInstance) {
