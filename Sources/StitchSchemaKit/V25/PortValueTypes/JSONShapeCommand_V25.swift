...
public enum JSONShapeCommand_V25: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V25
    public typealias PreviousInstance = JSONShapeCommand_V24.JSONShapeCommand
    public typealias JSONCurveTo = JSONCurveTo_V25.JSONCurveTo
    // MARK: - endif
...
extension JSONShapeCommand_V25.JSONShapeCommand {
...
extension Array where Element == JSONShapeCommand_V25.JSONShapeCommand {
    public func getPoints() -> [CGPoint] {
        self.map { $0.point }
    }
}

extension JSONShapeCommand_V25.JSONShapeCommand: StitchVersionedCodable {
    public init(previousInstance: JSONShapeCommand_V25.PreviousInstance) {
        ...
        case .curveTo(let value):
            self = .curveTo(JSONShapeCommand_V25.JSONCurveTo(previousInstance: value))
        }
    }
}
