...
public enum JSONShapeKeys_V25: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V25
    public typealias PreviousInstance = JSONShapeKeys_V24.JSONShapeKeys
    // MARK: - endif
...
extension JSONShapeKeys_V25.JSONShapeKeys: StitchVersionedCodable {
    public init(previousInstance: JSONShapeKeys_V25.PreviousInstance) {
        fatalError()
    }
}
