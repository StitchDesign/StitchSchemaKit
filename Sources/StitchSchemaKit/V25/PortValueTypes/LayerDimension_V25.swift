...
public enum LayerDimension_V25: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V25
    public typealias PreviousInstance = LayerDimension_V24.LayerDimension
    // MARK: - endif
...
extension LayerDimension_V25.LayerDimension: StitchVersionedCodable {
    public init(previousInstance: LayerDimension_V25.PreviousInstance) {
