...
public enum LayerTextDecoration_V25: StitchSchemaVersionable {
...
extension LayerTextDecoration_V25.LayerTextDecoration: StitchVersionedCodable {
    public init(previousInstance: LayerTextDecoration_V25.PreviousInstance) {
