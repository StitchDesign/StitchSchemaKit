...
public enum PathPoint_V25: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V25
    public typealias PreviousInstance = PathPoint_V24.PathPoint
    // MARK: - endif
...
extension PathPoint_V25.PathPoint: StitchVersionedCodable {
    public init(previousInstance: PathPoint_V25.PreviousInstance) {
