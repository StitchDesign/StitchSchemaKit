...
public enum ShapeAndRect_V25: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V25
    public typealias PreviousInstance = ShapeAndRect_V24.ShapeAndRect
    public typealias RoundedRectangleData = RoundedRectangleData_V25.RoundedRectangleData
    public typealias TriangleData = TriangleData_V25.TriangleData
...
extension ShapeAndRect_V25.ShapeAndRect {
...
extension ShapeAndRect_V25.ShapeAndRect: StitchVersionedCodable {
    public init(previousInstance: ShapeAndRect_V25.PreviousInstance) {
