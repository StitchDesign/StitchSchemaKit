...
public enum StitchBlendMode_V25: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V25
    public typealias PreviousInstance = StitchBlendMode_V24.StitchBlendMode
...
extension StitchBlendMode_V25.StitchBlendMode: StitchVersionedCodable {
    public init(previousInstance: StitchBlendMode_V25.PreviousInstance) {
