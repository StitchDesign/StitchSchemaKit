...
public enum StitchFontWeight_V25: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V25
    public typealias PreviousInstance = StitchFontWeight_V24.StitchFontWeight
    // MARK: - endif
...
extension StitchFontWeight_V25.StitchFontWeight: StitchVersionedCodable {
    public init(previousInstance: StitchFontWeight_V25.PreviousInstance) {
