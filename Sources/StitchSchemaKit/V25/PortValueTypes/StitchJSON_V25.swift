...
public enum StitchJSON_V25: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V25
    public typealias PreviousInstance = StitchJSON_V24.StitchJSON
    // MARK: - endif
...
extension StitchJSON_V25.StitchJSON: StitchVersionedCodable {
    public init(previousInstance: StitchJSON_V25.PreviousInstance) {
