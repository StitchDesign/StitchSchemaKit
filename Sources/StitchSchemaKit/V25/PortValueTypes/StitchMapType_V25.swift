...
public enum StitchMapType_V25: StitchSchemaVersionable {
...
extension StitchMapType_V25.StitchMapType: StitchVersionedCodable {
    public init(previousInstance: StitchMapType_V25.PreviousInstance) {
