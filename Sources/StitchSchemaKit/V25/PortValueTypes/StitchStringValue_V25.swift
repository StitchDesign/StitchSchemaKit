...
public enum StitchStringValue_V25: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V25
    public typealias PreviousInstance = StitchStringValue_V24.StitchStringValue
    // MARK: - end
...
extension StitchStringValue_V25.StitchStringValue: StitchVersionedCodable {
    public init(previousInstance: StitchStringValue_V25.PreviousInstance) {
