...
public enum TriangleData_V25: StitchSchemaVersionable {
...
extension TriangleData_V25.TriangleData: StitchVersionedCodable {
    public init(previousInstance: TriangleData_V25.PreviousInstance) {
