...
public enum PreviewSize_V25: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V25
    public typealias PreviousInstance = PreviewSize_V24.PreviewSize
    // MARK: - endif
...
extension PreviewSize_V25.PreviewSize: StitchVersionedCodable {
    public init(previousInstance: PreviewSize_V25.PreviousInstance) {
