...
public enum SplitterType_V25: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V25
    public typealias PreviousInstance = SplitterType_V24.SplitterType
    // MARK: - endif
...
extension SplitterType_V25.SplitterType: StitchVersionedCodable {
    public init(previousInstance: SplitterType_V25.PreviousInstance) {
