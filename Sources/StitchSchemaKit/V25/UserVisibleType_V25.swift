...
public enum UserVisibleType_V25: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V25
    public typealias PreviousInstance = UserVisibleType_V24.UserVisibleType
    // MARK: - endif
...
extension UserVisibleType_V25.UserVisibleType: StitchVersionedCodable {
    public init(previousInstance: UserVisibleType_V25.PreviousInstance) {
