...
public enum Layer_V26: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V26
    public typealias PreviousInstance = Layer_V25.Layer
    // MARK: - endif
...
extension Layer_V26.Layer: StitchVersionedCodable {
    public init(previousInstance: Layer_V26.PreviousInstance) {
