...
public enum LayerInputPort_V26: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V26
    public typealias PreviousInstance = LayerInputPort_V25.LayerInputPort
    // MARK: - endif
...
extension LayerInputPort_V26.LayerInputPort: StitchVersionedCodable {
    public init(previousInstance: LayerInputPort_V26.PreviousInstance) {
