...
public enum Patch_V26: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V26
    public typealias PreviousInstance = Patch_V25.Patch
    // MARK: - endif
...
extension Patch_V26.Patch: StitchVersionedCodable {
    public init(previousInstance: Patch_V26.PreviousInstance) {
