...
public enum Anchoring_V26: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V26
    public typealias PreviousInstance = Anchoring_V25.Anchoring
    // MARK: - endif
...
extension Anchoring_V26.Anchoring: StitchVersionedCodable {
    public init(previousInstance: Anchoring_V26.PreviousInstance) {
