...
public enum CustomShape_V26: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V26
    public typealias PreviousInstance = CustomShape_V25.CustomShape
    public typealias ShapeAndRect = ShapeAndRect_V26.ShapeAndRect
...
extension CustomShape_V26.CustomShape: StitchVersionedCodable {
    public init(previousInstance: CustomShape_V26.PreviousInstance) {
