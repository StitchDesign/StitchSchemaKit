...
public enum JSONShapeCommand_V26: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V26
    public typealias PreviousInstance = JSONShapeCommand_V25.JSONShapeCommand
    public typealias JSONCurveTo = JSONCurveTo_V26.JSONCurveTo
    // MARK: - endif
...
extension JSONShapeCommand_V26.JSONShapeCommand {
...
extension Array where Element == JSONShapeCommand_V26.JSONShapeCommand {
    public func getPoints() -> [CGPoint] {
        self.map { $0.point }
    }
}

extension JSONShapeCommand_V26.JSONShapeCommand: StitchVersionedCodable {
    public init(previousInstance: JSONShapeCommand_V26.PreviousInstance) {
        ...
        case .curveTo(let value):
            self = .curveTo(JSONShapeCommand_V26.JSONCurveTo(previousInstance: value))
        }
    }
}
