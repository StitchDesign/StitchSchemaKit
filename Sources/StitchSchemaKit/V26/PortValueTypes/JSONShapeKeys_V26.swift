...
public enum JSONShapeKeys_V26: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V26
    public typealias PreviousInstance = JSONShapeKeys_V25.JSONShapeKeys
    // MARK: - endif
...
extension JSONShapeKeys_V26.JSONShapeKeys: StitchVersionedCodable {
    public init(previousInstance: JSONShapeKeys_V26.PreviousInstance) {
        fatalError()
    }
}
