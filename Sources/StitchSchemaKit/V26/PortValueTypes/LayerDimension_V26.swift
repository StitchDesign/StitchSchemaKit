...
public enum LayerDimension_V26: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V26
    public typealias PreviousInstance = LayerDimension_V25.LayerDimension
    // MARK: - endif
...
extension LayerDimension_V26.LayerDimension: StitchVersionedCodable {
    public init(previousInstance: LayerDimension_V26.PreviousInstance) {
