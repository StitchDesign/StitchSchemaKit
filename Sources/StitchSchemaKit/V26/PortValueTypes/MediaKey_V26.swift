...
public enum MediaKey_V26: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V26
    public typealias PreviousInstance = MediaKey_V25.MediaKey
    // MARK: - endif
...
extension MediaKey_V26.MediaKey: StitchVersionedCodable {
    public init(previousInstance: MediaKey_V26.PreviousInstance) {
