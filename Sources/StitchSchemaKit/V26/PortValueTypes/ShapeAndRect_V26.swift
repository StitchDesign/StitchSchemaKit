...
public enum ShapeAndRect_V26: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V26
    public typealias PreviousInstance = ShapeAndRect_V25.ShapeAndRect
    public typealias RoundedRectangleData = RoundedRectangleData_V26.RoundedRectangleData
    public typealias TriangleData = TriangleData_V26.TriangleData
    public typealias JSONShapeCommands = [JSONShapeCommand_V26.JSONShapeCommand]
    // MARK: - endif
...
extension ShapeAndRect_V26.ShapeAndRect {
...
extension ShapeAndRect_V26.ShapeAndRect: StitchVersionedCodable {
    public init(previousInstance: ShapeAndRect_V26.PreviousInstance) {
