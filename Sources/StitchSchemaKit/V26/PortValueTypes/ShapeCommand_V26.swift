...
public enum ShapeCommand_V26: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V26
    public typealias PreviousInstance = ShapeCommand_V25.ShapeCommand
    public typealias PathPoint = PathPoint_V26.PathPoint
    // MARK: - endif
...
extension ShapeCommand_V26.ShapeCommand: StitchVersionedCodable {
    public init(previousInstance: ShapeCommand_V26.PreviousInstance) {
...
extension ShapeCommand_V26.ShapeCommand: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        case .lineTo:
            let point = try container.decode(PathPoint_V26.PathPoint.self, forKey: .point)
        ...
        case .curveTo:
            ...
            let curveFrom = try container.decode(PathPoint_V26.PathPoint.self, forKey: .curveFrom)
            let curveTo = try container.decode(PathPoint_V26.PathPoint.self, forKey: .curveTo)
