...
public enum StitchBlendMode_V26: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V26
    public typealias PreviousInstance = StitchBlendMode_V25.StitchBlendMode
...
extension StitchBlendMode_V26.StitchBlendMode: StitchVersionedCodable {
    public init(previousInstance: StitchBlendMode_V26.PreviousInstance) {
