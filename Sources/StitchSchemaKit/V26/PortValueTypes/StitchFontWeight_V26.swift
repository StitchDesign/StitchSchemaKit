...
public enum StitchFontWeight_V26: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V26
    public typealias PreviousInstance = StitchFontWeight_V25.StitchFontWeight
    // MARK: - endif
...
extension StitchFontWeight_V26.StitchFontWeight: StitchVersionedCodable {
    public init(previousInstance: StitchFontWeight_V26.PreviousInstance) {
