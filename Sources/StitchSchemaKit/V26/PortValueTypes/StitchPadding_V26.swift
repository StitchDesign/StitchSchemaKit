...
public enum StitchPadding_V26: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V26
    public typealias PreviousInstance = StitchPadding_V25.StitchPadding
    // MARK: - end
...
extension StitchPadding_V26.StitchPadding: StitchVersionedCodable {
    public init(previousInstance: StitchPadding_V26.PreviousInstance) {
