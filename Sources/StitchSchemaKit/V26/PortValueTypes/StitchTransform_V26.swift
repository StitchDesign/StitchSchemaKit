...
public enum StitchTransform_V26: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V26
    public typealias PreviousInstance = StitchTransform_V25.StitchTransform
    // MARK: - endif
...
extension StitchTransform_V26.StitchTransform: StitchVersionedCodable {
    public init(previousInstance: StitchTransform_V26.PreviousInstance) {
