...
public enum TriangleData_V26: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V26
    public typealias PreviousInstance = TriangleData_V25.TriangleData
    // MARK: - endif
...
extension TriangleData_V26.TriangleData: StitchVersionedCodable {
    public init(previousInstance: TriangleData_V26.PreviousInstance) {
