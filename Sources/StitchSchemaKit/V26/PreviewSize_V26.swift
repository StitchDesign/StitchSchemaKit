...
public enum PreviewSize_V26: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V26
    public typealias PreviousInstance = PreviewSize_V25.PreviewSize
    // MARK: - endif
...
extension PreviewSize_V26.PreviewSize: StitchVersionedCodable {
    public init(previousInstance: PreviewSize_V26.PreviousInstance) {
