...
public enum UserVisibleType_V26: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V26
    public typealias PreviousInstance = UserVisibleType_V25.UserVisibleType
    // MARK: - endif
...
extension UserVisibleType_V26.UserVisibleType: StitchVersionedCodable {
    public init(previousInstance: UserVisibleType_V26.PreviousInstance) {
