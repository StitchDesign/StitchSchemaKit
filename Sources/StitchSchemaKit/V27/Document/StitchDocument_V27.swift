...
public enum StitchDocument_V27: StitchSchemaVersionable {

    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V27
    public typealias PreviousInstance = StitchDocument_V26.StitchDocument
    public typealias GraphEntity = GraphEntity_V27.GraphEntity
    public typealias PreviewSize = PreviewSize_V27.PreviewSize
    public typealias CameraSettings = CameraSettings_V27.CameraSettings
    // MARK: - end
...
extension StitchDocument_V27.StitchDocument {
    public init(previousInstance: StitchDocument_V27.PreviousInstance) {
