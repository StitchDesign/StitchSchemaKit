...
public enum LayerNodeEntity_V27: StitchSchemaVersionable {

    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V27
    public typealias PreviousInstance = LayerNodeEntity_V26.LayerNodeEntity
    public typealias CanvasNodeEntity = CanvasNodeEntity_V27.CanvasNodeEntity
    public typealias Layer = Layer_V27.Layer
    public typealias LayerInputEntity = LayerInputEntity_V27.LayerInputEntity
...
extension LayerNodeEntity_V27.LayerNodeEntity: StitchVersionedCodable {
    public init(previousInstance: LayerNodeEntity_V27.PreviousInstance) {
        self.init(id: previousInstance.id,
                  layer: LayerNodeEntity_V27.Layer(previousInstance: previousInstance.layer),
                  ...
                  sizePort: LayerNodeEntity_V27.LayerInputEntity.init(previousInstance: previousInstance.sizePort),
