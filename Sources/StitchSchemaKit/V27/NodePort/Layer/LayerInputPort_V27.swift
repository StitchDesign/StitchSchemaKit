...
public enum LayerInputPort_V27: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V27
    public typealias PreviousInstance = LayerInputPort_V26.LayerInputPort
    // MARK: - endif
...
extension LayerInputPort_V27.LayerInputPort: StitchVersionedCodable {
    public init(previousInstance: LayerInputPort_V27.PreviousInstance) {
