...
public enum Patch_V27: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V27
    public typealias PreviousInstance = Patch_V26.Patch
    // MARK: - endif
...
extension Patch_V27.Patch: StitchVersionedCodable {
    public init(previousInstance: Patch_V27.PreviousInstance) {
