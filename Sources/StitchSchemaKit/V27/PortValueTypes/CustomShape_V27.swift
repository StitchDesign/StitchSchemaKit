...
public enum CustomShape_V27: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V27
    public typealias PreviousInstance = CustomShape_V26.CustomShape
    public typealias ShapeAndRect = ShapeAndRect_V27.ShapeAndRect
...
extension CustomShape_V27.CustomShape: StitchVersionedCodable {
    public init(previousInstance: CustomShape_V27.PreviousInstance) {
