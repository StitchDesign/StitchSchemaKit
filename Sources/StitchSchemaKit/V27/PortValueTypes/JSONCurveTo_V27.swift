...
public enum JSONCurveTo_V27: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V27
    public typealias PreviousInstance = JSONCurveTo_V26.JSONCurveTo
    // MARK: - endif
...
extension JSONCurveTo_V27.JSONCurveTo: StitchVersionedCodable {
    public init(previousInstance: JSONCurveTo_V27.PreviousInstance) {
