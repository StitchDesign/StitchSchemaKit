...
public enum LayerDimension_V27: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V27
    public typealias PreviousInstance = LayerDimension_V26.LayerDimension
    // MARK: - endif
...
extension LayerDimension_V27.LayerDimension: StitchVersionedCodable {
    public init(previousInstance: LayerDimension_V27.PreviousInstance) {
