...
public enum LayerSize_V27: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V27
    public typealias PreviousInstance = LayerSize_V26.LayerSize
...
extension LayerSize_V27.LayerSize: StitchVersionedCodable {
    public init(previousInstance: LayerSize_V27.PreviousInstance) {
