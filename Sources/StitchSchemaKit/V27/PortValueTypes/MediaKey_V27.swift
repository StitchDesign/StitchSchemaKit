...
public enum MediaKey_V27: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V27
    public typealias PreviousInstance = MediaKey_V26.MediaKey
    // MARK: - endif
...
extension MediaKey_V27.MediaKey: StitchVersionedCodable {
    public init(previousInstance: MediaKey_V27.PreviousInstance) {
