...
public enum ShapeAndRect_V27: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V27
    public typealias PreviousInstance = ShapeAndRect_V26.ShapeAndRect
    public typealias RoundedRectangleData = RoundedRectangleData_V27.RoundedRectangleData
    public typealias TriangleData = TriangleData_V27.TriangleData
    public typealias JSONShapeCommands = [JSONShapeCommand_V27.JSONShapeCommand]
    // MARK: - endif
...
extension ShapeAndRect_V27.ShapeAndRect {
...
extension ShapeAndRect_V27.ShapeAndRect: StitchVersionedCodable {
    public init(previousInstance: ShapeAndRect_V27.PreviousInstance) {
