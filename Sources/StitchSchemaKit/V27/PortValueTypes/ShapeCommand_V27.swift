...
public enum ShapeCommand_V27: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V27
    public typealias PreviousInstance = ShapeCommand_V26.ShapeCommand
    public typealias PathPoint = PathPoint_V27.PathPoint
    // MARK: - endif
...
extension ShapeCommand_V27.ShapeCommand: StitchVersionedCodable {
    public init(previousInstance: ShapeCommand_V27.PreviousInstance) {
...
extension ShapeCommand_V27.ShapeCommand: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        case .lineTo:
            let point = try container.decode(PathPoint_V27.PathPoint.self, forKey: .point)
        ...
        case .curveTo:
            ...
            let curveFrom = try container.decode(PathPoint_V27.PathPoint.self, forKey: .curveFrom)
            let curveTo = try container.decode(PathPoint_V27.PathPoint.self, forKey: .curveTo)
