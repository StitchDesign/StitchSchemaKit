...
public enum SizingScenario_V27: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V27
    public typealias PreviousInstance = SizingScenario_V26.SizingScenario
    // MARK: - end
...
extension SizingScenario_V27.SizingScenario: StitchVersionedCodable {
    public init(previousInstance: SizingScenario_V27.PreviousInstance) {
