...
public enum StitchFontWeight_V27: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V27
    public typealias PreviousInstance = StitchFontWeight_V26.StitchFontWeight
    // MARK: - endif
...
extension StitchFontWeight_V27.StitchFontWeight: StitchVersionedCodable {
    public init(previousInstance: StitchFontWeight_V27.PreviousInstance) {
