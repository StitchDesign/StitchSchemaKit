...
public enum StitchJSON_V27: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V27
    public typealias PreviousInstance = StitchJSON_V26.StitchJSON
    // MARK: - endif
...
extension StitchJSON_V27.StitchJSON: StitchVersionedCodable {
    public init(previousInstance: StitchJSON_V27.PreviousInstance) {
