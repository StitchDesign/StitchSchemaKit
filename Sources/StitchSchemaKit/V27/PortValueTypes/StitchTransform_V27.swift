...
public enum StitchTransform_V27: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V27
    public typealias PreviousInstance = StitchTransform_V26.StitchTransform
    // MARK: - endif
...
extension StitchTransform_V27.StitchTransform: StitchVersionedCodable {
    public init(previousInstance: StitchTransform_V27.PreviousInstance) {
