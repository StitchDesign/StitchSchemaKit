...
public enum TriangleData_V27: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V27
    public typealias PreviousInstance = TriangleData_V26.TriangleData
    // MARK: - endif
...
extension TriangleData_V27.TriangleData: StitchVersionedCodable {
    public init(previousInstance: TriangleData_V27.PreviousInstance) {
