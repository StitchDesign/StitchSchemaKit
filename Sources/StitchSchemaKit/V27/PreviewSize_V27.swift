...
public enum PreviewSize_V27: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V27
    public typealias PreviousInstance = PreviewSize_V26.PreviewSize
    // MARK: - endif
...
extension PreviewSize_V27.PreviewSize: StitchVersionedCodable {
    public init(previousInstance: PreviewSize_V27.PreviousInstance) {
