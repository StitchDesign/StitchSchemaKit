...
public enum UserVisibleType_V27: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V27
    public typealias PreviousInstance = UserVisibleType_V26.UserVisibleType
    // MARK: - endif
...
extension UserVisibleType_V27.UserVisibleType: StitchVersionedCodable {
    public init(previousInstance: UserVisibleType_V27.PreviousInstance) {
