...
public enum Layer_V28: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V28
    public typealias PreviousInstance = Layer_V27.Layer
    // MARK: - endif
...
extension Layer_V28.Layer: StitchVersionedCodable {
    public init(previousInstance: Layer_V28.PreviousInstance) {
