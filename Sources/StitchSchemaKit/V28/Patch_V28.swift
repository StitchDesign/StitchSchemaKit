...
public enum Patch_V28: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V28
    public typealias PreviousInstance = Patch_V27.Patch
    // MARK: - endif
...
extension Patch_V28.Patch: StitchVersionedCodable {
    public init(previousInstance: Patch_V28.PreviousInstance) {
        ...
        case .nativeScrollInteraction: // added to V27 but not released; then phased out in V28 in favor of layer group scroll inputs
            self = .scrollInteraction
        }
    }
}
