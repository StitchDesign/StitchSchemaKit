...
public enum Anchoring_V28: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V28
    public typealias PreviousInstance = Anchoring_V27.Anchoring
    // MARK: - endif
...
extension Anchoring_V28.Anchoring: StitchVersionedCodable {
    public init(previousInstance: Anchoring_V28.PreviousInstance) {
