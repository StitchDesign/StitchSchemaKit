...
public enum CustomShape_V28: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V28
    public typealias PreviousInstance = CustomShape_V27.CustomShape
    public typealias ShapeAndRect = ShapeAndRect_V28.ShapeAndRect
...
extension CustomShape_V28.CustomShape: StitchVersionedCodable {
    public init(previousInstance: CustomShape_V28.PreviousInstance) {
