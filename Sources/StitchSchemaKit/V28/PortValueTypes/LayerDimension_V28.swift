...
public enum LayerDimension_V28: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V28
    public typealias PreviousInstance = LayerDimension_V27.LayerDimension
    // MARK: - endif
...
extension LayerDimension_V28.LayerDimension: StitchVersionedCodable {
    public init(previousInstance: LayerDimension_V28.PreviousInstance) {
