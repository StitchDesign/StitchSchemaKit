...
public enum LayerSize_V28: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V28
    public typealias PreviousInstance = LayerSize_V27.LayerSize
...
extension LayerSize_V28.LayerSize: StitchVersionedCodable {
    public init(previousInstance: LayerSize_V28.PreviousInstance) {
