...
public enum PathPoint_V28: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V28
    public typealias PreviousInstance = PathPoint_V27.PathPoint
    // MARK: - endif
...
extension PathPoint_V28.PathPoint: StitchVersionedCodable {
    public init(previousInstance: PathPoint_V28.PreviousInstance) {
