...
public enum ShapeAndRect_V28: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V28
    public typealias PreviousInstance = ShapeAndRect_V27.ShapeAndRect
    public typealias RoundedRectangleData = RoundedRectangleData_V28.RoundedRectangleData
    public typealias TriangleData = TriangleData_V28.TriangleData
    public typealias JSONShapeCommands = [JSONShapeCommand_V28.JSONShapeCommand]
    // MARK: - endif
...
extension ShapeAndRect_V28.ShapeAndRect {
...
extension ShapeAndRect_V28.ShapeAndRect: StitchVersionedCodable {
    public init(previousInstance: ShapeAndRect_V28.PreviousInstance) {
