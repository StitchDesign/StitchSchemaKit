...
public enum StitchBlendMode_V28: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V28
    public typealias PreviousInstance = StitchBlendMode_V27.StitchBlendMode
...
extension StitchBlendMode_V28.StitchBlendMode: StitchVersionedCodable {
    public init(previousInstance: StitchBlendMode_V28.PreviousInstance) {
