...
public enum StitchFontWeight_V28: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V28
    public typealias PreviousInstance = StitchFontWeight_V27.StitchFontWeight
    // MARK: - endif
...
extension StitchFontWeight_V28.StitchFontWeight: StitchVersionedCodable {
    public init(previousInstance: StitchFontWeight_V28.PreviousInstance) {
