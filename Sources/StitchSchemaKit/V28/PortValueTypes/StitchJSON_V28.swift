...
public enum StitchJSON_V28: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V28
    public typealias PreviousInstance = StitchJSON_V27.StitchJSON
    // MARK: - endif
...
extension StitchJSON_V28.StitchJSON: StitchVersionedCodable {
    public init(previousInstance: StitchJSON_V28.PreviousInstance) {
