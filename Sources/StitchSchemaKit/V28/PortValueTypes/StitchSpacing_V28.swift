...
public enum StitchSpacing_V28: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V28
    public typealias PreviousInstance = StitchSpacing_V27.StitchSpacing
    // MARK: - end
...
extension StitchSpacing_V28.StitchSpacing: StitchVersionedCodable {
    public init(previousInstance: StitchSpacing_V28.PreviousInstance) {
