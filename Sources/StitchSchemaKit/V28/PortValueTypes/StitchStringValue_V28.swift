...
public enum StitchStringValue_V28: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V28
    public typealias PreviousInstance = StitchStringValue_V27.StitchStringValue
    // MARK: - end
...
extension StitchStringValue_V28.StitchStringValue: StitchVersionedCodable {
    public init(previousInstance: StitchStringValue_V28.PreviousInstance) {
