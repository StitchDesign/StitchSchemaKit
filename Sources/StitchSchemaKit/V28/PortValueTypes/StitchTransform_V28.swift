...
public enum StitchTransform_V28: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V28
    public typealias PreviousInstance = StitchTransform_V27.StitchTransform
    // MARK: - endif
...
extension StitchTransform_V28.StitchTransform: StitchVersionedCodable {
    public init(previousInstance: StitchTransform_V28.PreviousInstance) {
