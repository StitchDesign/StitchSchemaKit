...
public enum TriangleData_V28: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V28
    public typealias PreviousInstance = TriangleData_V27.TriangleData
    // MARK: - endif
...
extension TriangleData_V28.TriangleData: StitchVersionedCodable {
    public init(previousInstance: TriangleData_V28.PreviousInstance) {
