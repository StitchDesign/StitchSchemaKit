...
public enum PreviewSize_V28: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V28
    public typealias PreviousInstance = PreviewSize_V27.PreviewSize
    // MARK: - endif
...
extension PreviewSize_V28.PreviewSize: StitchVersionedCodable {
    public init(previousInstance: PreviewSize_V28.PreviousInstance) {
