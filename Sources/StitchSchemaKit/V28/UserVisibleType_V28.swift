...
public enum UserVisibleType_V28: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V28
    public typealias PreviousInstance = UserVisibleType_V27.UserVisibleType
    // MARK: - endif
...
extension UserVisibleType_V28.UserVisibleType: StitchVersionedCodable {
    public init(previousInstance: UserVisibleType_V28.PreviousInstance) {
