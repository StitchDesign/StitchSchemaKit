...
public enum CommentBoxData_V29: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V29
    public typealias PreviousInstance = CommentBoxData_V28.CommentBoxData
    public typealias CanvasItemId = CanvasItemId_V29.CanvasItemId
    // MARK: - endif
...
extension CommentBoxData_V29.CommentBoxData: StitchVersionedCodable {
    public init(previousInstance: CommentBoxData_V29.PreviousInstance) {
