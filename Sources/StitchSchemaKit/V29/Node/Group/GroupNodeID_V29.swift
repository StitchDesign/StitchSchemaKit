...
public enum GroupNodeID_V29: StitchSchemaVersionable {
...
extension GroupNodeID_V29.GroupNodeId: StitchVersionedCodable {
    public init(previousInstance: GroupNodeID_V29.PreviousInstance) {
