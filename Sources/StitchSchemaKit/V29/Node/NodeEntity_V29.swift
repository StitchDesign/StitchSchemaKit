...
public enum NodeEntity_V29: StitchSchemaVersionable {

    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V28
    public typealias PreviousInstance = NodeEntity_V28.NodeEntity
    public typealias NodeTypeEntity = NodeTypeEntity_V29.NodeTypeEntity
    // MARK: - end
...
extension NodeEntity_V29.NodeEntity: StitchVersionedCodable {
    public init(previousInstance: NodeEntity_V29.PreviousInstance) {
