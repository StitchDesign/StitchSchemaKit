...
public enum Patch_V29: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V29
    public typealias PreviousInstance = Patch_V28.Patch
    // MARK: - endif
...
extension Patch_V29.Patch: StitchVersionedCodable {
    public init(previousInstance: Patch_V29.PreviousInstance) {
