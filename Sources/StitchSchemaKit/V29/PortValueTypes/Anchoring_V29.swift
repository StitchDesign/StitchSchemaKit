...
public enum Anchoring_V29: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V29
    public typealias PreviousInstance = Anchoring_V28.Anchoring
    // MARK: - endif
...
extension Anchoring_V29.Anchoring: StitchVersionedCodable {
    public init(previousInstance: Anchoring_V29.PreviousInstance) {
