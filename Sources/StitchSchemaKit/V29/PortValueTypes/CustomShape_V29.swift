...
public enum CustomShape_V29: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V29
    public typealias PreviousInstance = CustomShape_V28.CustomShape
    public typealias ShapeAndRect = ShapeAndRect_V29.ShapeAndRect
...
extension CustomShape_V29.CustomShape: StitchVersionedCodable {
    public init(previousInstance: CustomShape_V29.PreviousInstance) {
