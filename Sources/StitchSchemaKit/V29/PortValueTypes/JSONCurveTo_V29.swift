...
public enum JSONCurveTo_V29: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V29
    public typealias PreviousInstance = JSONCurveTo_V28.JSONCurveTo
    // MARK: - endif
...
extension JSONCurveTo_V29.JSONCurveTo: StitchVersionedCodable {
    public init(previousInstance: JSONCurveTo_V29.PreviousInstance) {
