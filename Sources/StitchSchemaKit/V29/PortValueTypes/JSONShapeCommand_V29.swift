...
public enum JSONShapeCommand_V29: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V29
    public typealias PreviousInstance = JSONShapeCommand_V28.JSONShapeCommand
    public typealias JSONCurveTo = JSONCurveTo_V29.JSONCurveTo
    // MARK: - endif
...
extension JSONShapeCommand_V29.JSONShapeCommand {
...
extension Array where Element == JSONShapeCommand_V29.JSONShapeCommand {
    public func getPoints() -> [CGPoint] {
        self.map { $0.point }
    }
}

extension JSONShapeCommand_V29.JSONShapeCommand: StitchVersionedCodable {
    public init(previousInstance: JSONShapeCommand_V29.PreviousInstance) {
        ...
        case .curveTo(let value):
            self = .curveTo(JSONShapeCommand_V29.JSONCurveTo(previousInstance: value))
        }
    }
}
