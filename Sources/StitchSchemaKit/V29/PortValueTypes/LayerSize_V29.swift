...
public enum LayerSize_V29: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V29
    public typealias PreviousInstance = LayerSize_V28.LayerSize
...
extension LayerSize_V29.LayerSize: StitchVersionedCodable {
    public init(previousInstance: LayerSize_V29.PreviousInstance) {
