...
public enum MediaKey_V29: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V29
    public typealias PreviousInstance = MediaKey_V28.MediaKey
    // MARK: - endif
...
extension MediaKey_V29.MediaKey: StitchVersionedCodable {
    public init(previousInstance: MediaKey_V29.PreviousInstance) {
