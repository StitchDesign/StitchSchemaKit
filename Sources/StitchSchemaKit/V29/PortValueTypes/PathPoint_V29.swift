...
public enum PathPoint_V29: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V29
    public typealias PreviousInstance = PathPoint_V28.PathPoint
    // MARK: - endif
...
extension PathPoint_V29.PathPoint: StitchVersionedCodable {
    public init(previousInstance: PathPoint_V29.PreviousInstance) {
