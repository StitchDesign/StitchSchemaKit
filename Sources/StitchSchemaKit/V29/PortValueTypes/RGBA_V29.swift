...
public enum RGBA_V29: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V29
    public typealias PreviousInstance = RGBA_V28.RGBA
    // MARK: - endif
...
extension RGBA_V29.RGBA: StitchVersionedCodable {
    public init(previousInstance: RGBA_V29.PreviousInstance) {
