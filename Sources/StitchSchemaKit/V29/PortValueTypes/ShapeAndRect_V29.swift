...
public enum ShapeAndRect_V29: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V29
    public typealias PreviousInstance = ShapeAndRect_V28.ShapeAndRect
    public typealias RoundedRectangleData = RoundedRectangleData_V29.RoundedRectangleData
    public typealias TriangleData = TriangleData_V29.TriangleData
    public typealias JSONShapeCommands = [JSONShapeCommand_V29.JSONShapeCommand]
    // MARK: - endif
...
extension ShapeAndRect_V29.ShapeAndRect {
...
extension ShapeAndRect_V29.ShapeAndRect: StitchVersionedCodable {
    public init(previousInstance: ShapeAndRect_V29.PreviousInstance) {
