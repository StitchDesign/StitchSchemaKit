...
public enum ShapeCommand_V29: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V29
    public typealias PreviousInstance = ShapeCommand_V28.ShapeCommand
    public typealias PathPoint = PathPoint_V29.PathPoint
    // MARK: - endif
...
extension ShapeCommand_V29.ShapeCommand: StitchVersionedCodable {
    public init(previousInstance: ShapeCommand_V29.PreviousInstance) {
...
extension ShapeCommand_V29.ShapeCommand: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        case .lineTo:
            let point = try container.decode(PathPoint_V29.PathPoint.self, forKey: .point)
        ...
        case .curveTo:
            ...
            let curveFrom = try container.decode(PathPoint_V29.PathPoint.self, forKey: .curveFrom)
            let curveTo = try container.decode(PathPoint_V29.PathPoint.self, forKey: .curveTo)
