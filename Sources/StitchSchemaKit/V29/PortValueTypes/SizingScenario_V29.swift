...
public enum SizingScenario_V29: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V29
    public typealias PreviousInstance = SizingScenario_V28.SizingScenario
    // MARK: - end
...
extension SizingScenario_V29.SizingScenario: StitchVersionedCodable {
    public init(previousInstance: SizingScenario_V29.PreviousInstance) {
