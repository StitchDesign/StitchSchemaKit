...
public enum StitchBlendMode_V29: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V29
    public typealias PreviousInstance = StitchBlendMode_V28.StitchBlendMode
...
extension StitchBlendMode_V29.StitchBlendMode: StitchVersionedCodable {
    public init(previousInstance: StitchBlendMode_V29.PreviousInstance) {
