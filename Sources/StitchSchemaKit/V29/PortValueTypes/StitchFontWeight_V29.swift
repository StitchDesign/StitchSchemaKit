...
public enum StitchFontWeight_V29: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V29
    public typealias PreviousInstance = StitchFontWeight_V28.StitchFontWeight
    // MARK: - endif
...
extension StitchFontWeight_V29.StitchFontWeight: StitchVersionedCodable {
    public init(previousInstance: StitchFontWeight_V29.PreviousInstance) {
