...
public enum StitchPadding_V29: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V29
    public typealias PreviousInstance = StitchPadding_V28.StitchPadding
    // MARK: - end
...
extension StitchPadding_V29.StitchPadding: StitchVersionedCodable {
    public init(previousInstance: StitchPadding_V29.PreviousInstance) {
