...
public enum StitchStringValue_V29: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V29
    public typealias PreviousInstance = StitchStringValue_V28.StitchStringValue
    // MARK: - end
...
extension StitchStringValue_V29.StitchStringValue: StitchVersionedCodable {
    public init(previousInstance: StitchStringValue_V29.PreviousInstance) {
