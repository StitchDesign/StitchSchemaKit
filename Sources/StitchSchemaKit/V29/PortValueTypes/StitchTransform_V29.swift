...
public enum StitchTransform_V29: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V29
    public typealias PreviousInstance = StitchTransform_V28.StitchTransform
    // MARK: - endif
...
extension StitchTransform_V29.StitchTransform: StitchVersionedCodable {
    public init(previousInstance: StitchTransform_V29.PreviousInstance) {
