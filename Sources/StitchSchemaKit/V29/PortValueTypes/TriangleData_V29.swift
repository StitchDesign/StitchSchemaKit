...
public enum TriangleData_V29: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V29
    public typealias PreviousInstance = TriangleData_V28.TriangleData
    // MARK: - endif
...
extension TriangleData_V29.TriangleData: StitchVersionedCodable {
    public init(previousInstance: TriangleData_V29.PreviousInstance) {
