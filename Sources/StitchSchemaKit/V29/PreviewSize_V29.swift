...
public enum PreviewSize_V29: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V29
    public typealias PreviousInstance = PreviewSize_V28.PreviewSize
    // MARK: - endif
...
extension PreviewSize_V29.PreviewSize: StitchVersionedCodable {
    public init(previousInstance: PreviewSize_V29.PreviousInstance) {
