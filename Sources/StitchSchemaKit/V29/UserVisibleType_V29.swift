...
public enum UserVisibleType_V29: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V29
    public typealias PreviousInstance = UserVisibleType_V28.UserVisibleType
    // MARK: - endif
...
extension UserVisibleType_V29.UserVisibleType: StitchVersionedCodable {
    public init(previousInstance: UserVisibleType_V29.PreviousInstance) {
