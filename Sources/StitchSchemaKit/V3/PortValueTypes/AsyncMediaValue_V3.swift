...
public enum AsyncMediaValue_V3: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V3
    public typealias PreviousInstance = AsyncMediaValue_V2.AsyncMediaValue
    ...
    public struct AsyncMediaValue: Codable, Equatable, Hashable {
        ...
        public var dataType: DataType_V3.DataType<MediaKey_V3.MediaKey>
        
        public init(id: MediaObjectId, dataType: DataType_V3.DataType<MediaKey_V3.MediaKey>) {
            self.id = id
        ...
        public init(globalId: UUID, nodeId: NodeId, mediaKey: MediaKey_V3.MediaKey) {
...
extension AsyncMediaValue_V3.AsyncMediaValue: StitchVersionedCodable {
    public init(previousInstance: AsyncMediaValue_V3.PreviousInstance) {
        
        var dataType: DataType_V3.DataType<MediaKey_V3.MediaKey>
