...
public enum JSONShapeKeys_V3: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V3
    public typealias PreviousInstance = JSONShapeKeys_V2.JSONShapeKeys
    // MARK: - endif
...
extension JSONShapeKeys_V3.JSONShapeKeys: StitchVersionedCodable {
    public init(previousInstance: JSONShapeKeys_V3.PreviousInstance) {
        fatalError()
    }
}
