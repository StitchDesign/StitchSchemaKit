...
public enum LightType_V3: StitchSchemaVersionable {
...
extension LightType_V3.LightType: StitchVersionedCodable {
    public init(previousInstance: LightType_V3.PreviousInstance) {
