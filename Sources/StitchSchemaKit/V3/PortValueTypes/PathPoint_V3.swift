...
public enum PathPoint_V3: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V3
    public typealias PreviousInstance = PathPoint_V2.PathPoint
    // MARK: - endif
...
extension PathPoint_V3.PathPoint: StitchVersionedCodable {
    public init(previousInstance: PathPoint_V3.PreviousInstance) {
