...
public enum ShapeCommand_V3: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V3
    public typealias PreviousInstance = ShapeCommand_V2.ShapeCommand
...
extension ShapeCommand_V3.ShapeCommand: StitchVersionedCodable {
    public init(previousInstance: ShapeCommand_V3.PreviousInstance) {
...
extension ShapeCommand_V3.ShapeCommand: Codable {
