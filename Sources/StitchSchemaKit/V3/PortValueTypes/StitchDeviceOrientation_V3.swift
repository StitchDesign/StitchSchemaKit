//
//  StitchDeviceOrientation_V3.swift
//  
//
...
extension StitchDeviceOrientation_V3.StitchDeviceOrientation: StitchVersionedCodable {
    public init(previousInstance: StitchDeviceOrientation_V3.PreviousInstance) {
