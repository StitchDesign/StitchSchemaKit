...
public enum StitchFontWeight_V3: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V3
    public typealias PreviousInstance = StitchFontWeight_V2.StitchFontWeight
    // MARK: - endif
...
extension StitchFontWeight_V3.StitchFontWeight: StitchVersionedCodable {
    public init(previousInstance: StitchFontWeight_V3.PreviousInstance) {
