...
public enum TriangleData_V3: StitchSchemaVersionable {
...
extension TriangleData_V3.TriangleData: StitchVersionedCodable {
    public init(previousInstance: TriangleData_V3.PreviousInstance) {
