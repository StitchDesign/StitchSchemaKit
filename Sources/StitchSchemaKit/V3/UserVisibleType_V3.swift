...
public enum UserVisibleType_V3: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V3
    public typealias PreviousInstance = UserVisibleType_V2.UserVisibleType
    // MARK: - endif
...
extension UserVisibleType_V3.UserVisibleType: StitchVersionedCodable {
    public init(previousInstance: UserVisibleType_V3.PreviousInstance) {
