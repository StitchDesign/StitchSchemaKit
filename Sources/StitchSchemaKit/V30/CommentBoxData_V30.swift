...
public enum CommentBoxData_V30: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V30
    public typealias PreviousInstance = CommentBoxData_V29.CommentBoxData
    public typealias CanvasItemId = CanvasItemId_V30.CanvasItemId
    // MARK: - endif
...
extension CommentBoxData_V30.CommentBoxData: StitchVersionedCodable {
    public init(previousInstance: CommentBoxData_V30.PreviousInstance) {
