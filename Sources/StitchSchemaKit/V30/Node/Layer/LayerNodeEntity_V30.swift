...
public enum LayerNodeEntity_V30: StitchSchemaVersionable {

    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V30
    public typealias PreviousInstance = LayerNodeEntity_V29.LayerNodeEntity
    public typealias CanvasNodeEntity = CanvasNodeEntity_V30.CanvasNodeEntity
    public typealias Layer = Layer_V30.Layer
    public typealias LayerInputEntity = LayerInputEntity_V30.LayerInputEntity
...
extension LayerNodeEntity_V30.LayerNodeEntity: StitchVersionedCodable {
    public init(previousInstance: LayerNodeEntity_V30.PreviousInstance) {
        self.init(id: previousInstance.id,
                  layer: LayerNodeEntity_V30.Layer(previousInstance: previousInstance.layer),
                  ...
                  sizePort: LayerNodeEntity_V30.LayerInputEntity(previousInstance: previousInstance.sizePort),
