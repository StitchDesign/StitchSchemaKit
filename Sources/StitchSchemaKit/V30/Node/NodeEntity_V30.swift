...
public enum NodeEntity_V30: StitchSchemaVersionable {

    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V29
    public typealias PreviousInstance = NodeEntity_V29.NodeEntity
    public typealias NodeTypeEntity = NodeTypeEntity_V30.NodeTypeEntity
    // MARK: - end
...
extension NodeEntity_V30.NodeEntity: StitchVersionedCodable {
    public init(previousInstance: NodeEntity_V30.PreviousInstance) {
