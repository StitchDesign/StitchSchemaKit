...
public enum LayerInputPort_V30: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V30
    public typealias PreviousInstance = LayerInputPort_V29.LayerInputPort
    // MARK: - endif
...
extension LayerInputPort_V30.LayerInputPort: StitchVersionedCodable {
    public init(previousInstance: LayerInputPort_V30.PreviousInstance) {
...
extension LayerInputPort_V30.LayerInputPort {
    /// Keypath mapping to this schema version.
    var schemaPortKeyPath: WritableKeyPath<LayerNodeEntity_V30.LayerNodeEntity, LayerInputEntity_V30.LayerInputEntity> {
        switch self {
