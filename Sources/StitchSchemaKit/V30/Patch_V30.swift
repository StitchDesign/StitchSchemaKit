...
public enum Patch_V30: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V30
    public typealias PreviousInstance = Patch_V29.Patch
    // MARK: - endif
...
extension Patch_V30.Patch: StitchVersionedCodable {
    public init(previousInstance: Patch_V30.PreviousInstance) {
