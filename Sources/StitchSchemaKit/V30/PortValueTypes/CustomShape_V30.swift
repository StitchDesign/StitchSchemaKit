...
public enum CustomShape_V30: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V30
    public typealias PreviousInstance = CustomShape_V29.CustomShape
    public typealias ShapeAndRect = ShapeAndRect_V30.ShapeAndRect
...
extension CustomShape_V30.CustomShape: StitchVersionedCodable {
    public init(previousInstance: CustomShape_V30.PreviousInstance) {
