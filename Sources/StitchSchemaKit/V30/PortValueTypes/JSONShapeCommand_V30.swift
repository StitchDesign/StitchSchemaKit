...
public enum JSONShapeCommand_V30: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V30
    public typealias PreviousInstance = JSONShapeCommand_V29.JSONShapeCommand
    public typealias JSONCurveTo = JSONCurveTo_V30.JSONCurveTo
    // MARK: - endif
...
extension JSONShapeCommand_V30.JSONShapeCommand {
...
extension Array where Element == JSONShapeCommand_V30.JSONShapeCommand {
    public func getPoints() -> [CGPoint] {
        self.map { $0.point }
    }
}

extension JSONShapeCommand_V30.JSONShapeCommand: StitchVersionedCodable {
    public init(previousInstance: JSONShapeCommand_V30.PreviousInstance) {
        ...
        case .curveTo(let value):
            self = .curveTo(JSONShapeCommand_V30.JSONCurveTo(previousInstance: value))
        }
    }
}
