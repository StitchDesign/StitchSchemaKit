...
public enum JSONShapeKeys_V30: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V30
    public typealias PreviousInstance = JSONShapeKeys_V29.JSONShapeKeys
    // MARK: - endif
...
extension JSONShapeKeys_V30.JSONShapeKeys: StitchVersionedCodable {
    public init(previousInstance: JSONShapeKeys_V30.PreviousInstance) {
        fatalError()
    }
}
