...
public enum LayerDimension_V30: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V30
    public typealias PreviousInstance = LayerDimension_V29.LayerDimension
    // MARK: - endif
...
extension LayerDimension_V30.LayerDimension: StitchVersionedCodable {
    public init(previousInstance: LayerDimension_V30.PreviousInstance) {
