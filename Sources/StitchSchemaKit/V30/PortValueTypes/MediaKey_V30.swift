...
public enum MediaKey_V30: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V30
    public typealias PreviousInstance = MediaKey_V29.MediaKey
    // MARK: - endif
...
extension MediaKey_V30.MediaKey: StitchVersionedCodable {
    public init(previousInstance: MediaKey_V30.PreviousInstance) {
