...
public enum ShapeAndRect_V30: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V30
    public typealias PreviousInstance = ShapeAndRect_V29.ShapeAndRect
    public typealias RoundedRectangleData = RoundedRectangleData_V30.RoundedRectangleData
    public typealias TriangleData = TriangleData_V30.TriangleData
    public typealias JSONShapeCommands = [JSONShapeCommand_V30.JSONShapeCommand]
    // MARK: - endif
...
extension ShapeAndRect_V30.ShapeAndRect {
...
extension ShapeAndRect_V30.ShapeAndRect: StitchVersionedCodable {
    public init(previousInstance: ShapeAndRect_V30.PreviousInstance) {
