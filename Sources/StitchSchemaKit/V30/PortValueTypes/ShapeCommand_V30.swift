...
public enum ShapeCommand_V30: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V30
    public typealias PreviousInstance = ShapeCommand_V29.ShapeCommand
    public typealias PathPoint = PathPoint_V30.PathPoint
    // MARK: - endif
...
extension ShapeCommand_V30.ShapeCommand: StitchVersionedCodable {
    public init(previousInstance: ShapeCommand_V30.PreviousInstance) {
...
extension ShapeCommand_V30.ShapeCommand: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        case .lineTo:
            let point = try container.decode(PathPoint_V30.PathPoint.self, forKey: .point)
        ...
        case .curveTo:
            ...
            let curveFrom = try container.decode(PathPoint_V30.PathPoint.self, forKey: .curveFrom)
            let curveTo = try container.decode(PathPoint_V30.PathPoint.self, forKey: .curveTo)
