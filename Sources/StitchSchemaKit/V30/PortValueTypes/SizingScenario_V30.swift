...
public enum SizingScenario_V30: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V30
    public typealias PreviousInstance = SizingScenario_V29.SizingScenario
    // MARK: - end
...
extension SizingScenario_V30.SizingScenario: StitchVersionedCodable {
    public init(previousInstance: SizingScenario_V30.PreviousInstance) {
