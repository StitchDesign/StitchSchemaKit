...
public enum StitchBlendMode_V30: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V30
    public typealias PreviousInstance = StitchBlendMode_V29.StitchBlendMode
...
extension StitchBlendMode_V30.StitchBlendMode: StitchVersionedCodable {
    public init(previousInstance: StitchBlendMode_V30.PreviousInstance) {
