...
public enum StitchFontWeight_V30: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V30
    public typealias PreviousInstance = StitchFontWeight_V29.StitchFontWeight
    // MARK: - endif
...
extension StitchFontWeight_V30.StitchFontWeight: StitchVersionedCodable {
    public init(previousInstance: StitchFontWeight_V30.PreviousInstance) {
