...
public enum StitchStringValue_V30: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V30
    public typealias PreviousInstance = StitchStringValue_V29.StitchStringValue
    // MARK: - end
...
extension StitchStringValue_V30.StitchStringValue: StitchVersionedCodable {
    public init(previousInstance: StitchStringValue_V30.PreviousInstance) {
