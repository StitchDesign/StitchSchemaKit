...
public enum StitchTransform_V30: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V30
    public typealias PreviousInstance = StitchTransform_V29.StitchTransform
    // MARK: - endif
...
extension StitchTransform_V30.StitchTransform: StitchVersionedCodable {
    public init(previousInstance: StitchTransform_V30.PreviousInstance) {
