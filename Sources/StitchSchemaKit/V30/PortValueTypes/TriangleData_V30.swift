...
public enum TriangleData_V30: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V30
    public typealias PreviousInstance = TriangleData_V29.TriangleData
    // MARK: - endif
...
extension TriangleData_V30.TriangleData: StitchVersionedCodable {
    public init(previousInstance: TriangleData_V30.PreviousInstance) {
