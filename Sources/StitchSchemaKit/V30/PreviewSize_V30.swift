...
public enum PreviewSize_V30: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V30
    public typealias PreviousInstance = PreviewSize_V29.PreviewSize
    // MARK: - endif
...
extension PreviewSize_V30.PreviewSize: StitchVersionedCodable {
    public init(previousInstance: PreviewSize_V30.PreviousInstance) {
