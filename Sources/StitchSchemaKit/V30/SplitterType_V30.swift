...
public enum SplitterType_V30: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V30
    public typealias PreviousInstance = SplitterType_V29.SplitterType
    // MARK: - endif
...
extension SplitterType_V30.SplitterType: StitchVersionedCodable {
    public init(previousInstance: SplitterType_V30.PreviousInstance) {
