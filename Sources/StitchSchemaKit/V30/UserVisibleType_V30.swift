...
public enum UserVisibleType_V30: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V30
    public typealias PreviousInstance = UserVisibleType_V29.UserVisibleType
    // MARK: - endif
...
extension UserVisibleType_V30.UserVisibleType: StitchVersionedCodable {
    public init(previousInstance: UserVisibleType_V30.PreviousInstance) {
