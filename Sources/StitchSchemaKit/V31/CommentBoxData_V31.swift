...
public enum CommentBoxData_V31: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V31
    public typealias PreviousInstance = CommentBoxData_V30.CommentBoxData
    public typealias CanvasItemId = CanvasItemId_V31.CanvasItemId
    // MARK: - endif
...
extension CommentBoxData_V31.CommentBoxData: StitchVersionedCodable {
    public init(previousInstance: CommentBoxData_V31.PreviousInstance) {
