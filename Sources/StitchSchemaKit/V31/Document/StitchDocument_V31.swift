...
public enum StitchDocument_V31: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V31
    public typealias PreviousInstance = StitchDocument_V30.StitchDocument
    public typealias GraphEntity = GraphEntity_V31.GraphEntity
    public typealias PreviewSize = PreviewSize_V31.PreviewSize
    public typealias CameraSettings = CameraSettings_V31.CameraSettings
    // MARK: - end
...
extension StitchDocument_V31.StitchDocument {
    public init(previousInstance: StitchDocument_V31.PreviousInstance) {
