...
public enum NodeTypeEntity_V31: StitchSchemaVersionable {

    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V31
    public typealias PreviousInstance = NodeTypeEntity_V30.NodeTypeEntity
    // MARK: - end

    public enum NodeTypeEntity: Hashable {
        case patch(PatchNodeEntity_V31.PatchNodeEntity)
        case layer(LayerNodeEntity_V31.LayerNodeEntity)
        case group(CanvasNodeEntity_V31.CanvasNodeEntity)
        case component(ComponentEntity_V31.ComponentEntity)
    }
}

extension NodeTypeEntity_V31.NodeTypeEntity {
    public var kind: NodeKind_V31.NodeKind {
        switch self {
    ...
    var patchNodeEntity: PatchNodeEntity_V31.PatchNodeEntity? {
        switch self {
    ...
    func inputsModifier(callback: @escaping (NodeConnectionType_V31.NodeConnectionType) -> NodeConnectionType_V31.NodeConnectionType) -> Self {
        switch self {
        ...
        case .layer(var layerNodeEntity):
            let allPorts = LayerInputPort_V31.LayerInputPort.allCases
...
extension NodeTypeEntity_V31.NodeTypeEntity: StitchVersionedCodable {
    public init(previousInstance: NodeTypeEntity_V31.PreviousInstance) {
