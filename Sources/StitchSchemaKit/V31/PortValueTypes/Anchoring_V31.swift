...
public enum Anchoring_V31: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V31
    public typealias PreviousInstance = Anchoring_V30.Anchoring
    // MARK: - endif
...
extension Anchoring_V31.Anchoring: StitchVersionedCodable {
    public init(previousInstance: Anchoring_V31.PreviousInstance) {
