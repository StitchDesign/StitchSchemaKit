...
public enum CustomShape_V31: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V31
    public typealias PreviousInstance = CustomShape_V30.CustomShape
    public typealias ShapeAndRect = ShapeAndRect_V31.ShapeAndRect
...
extension CustomShape_V31.CustomShape: StitchVersionedCodable {
    public init(previousInstance: CustomShape_V31.PreviousInstance) {
