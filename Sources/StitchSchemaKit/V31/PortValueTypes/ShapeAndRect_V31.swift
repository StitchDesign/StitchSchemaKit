...
public enum ShapeAndRect_V31: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V31
    public typealias PreviousInstance = ShapeAndRect_V30.ShapeAndRect
    public typealias RoundedRectangleData = RoundedRectangleData_V31.RoundedRectangleData
    public typealias TriangleData = TriangleData_V31.TriangleData
    public typealias JSONShapeCommands = [JSONShapeCommand_V31.JSONShapeCommand]
    // MARK: - endif
...
extension ShapeAndRect_V31.ShapeAndRect {
...
extension ShapeAndRect_V31.ShapeAndRect: StitchVersionedCodable {
    public init(previousInstance: ShapeAndRect_V31.PreviousInstance) {
