...
public enum ShapeCommand_V31: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V31
    public typealias PreviousInstance = ShapeCommand_V30.ShapeCommand
    public typealias PathPoint = PathPoint_V31.PathPoint
    // MARK: - endif
...
extension ShapeCommand_V31.ShapeCommand: StitchVersionedCodable {
    public init(previousInstance: ShapeCommand_V31.PreviousInstance) {
...
extension ShapeCommand_V31.ShapeCommand: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        case .lineTo:
            let point = try container.decode(PathPoint_V31.PathPoint.self, forKey: .point)
        ...
        case .curveTo:
            ...
            let curveFrom = try container.decode(PathPoint_V31.PathPoint.self, forKey: .curveFrom)
            let curveTo = try container.decode(PathPoint_V31.PathPoint.self, forKey: .curveTo)
