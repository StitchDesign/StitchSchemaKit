...
public enum StitchBlendMode_V31: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V31
    public typealias PreviousInstance = StitchBlendMode_V30.StitchBlendMode
...
extension StitchBlendMode_V31.StitchBlendMode: StitchVersionedCodable {
    public init(previousInstance: StitchBlendMode_V31.PreviousInstance) {
