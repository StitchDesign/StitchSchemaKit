...
public enum StitchFontWeight_V31: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V31
    public typealias PreviousInstance = StitchFontWeight_V30.StitchFontWeight
    // MARK: - endif
...
extension StitchFontWeight_V31.StitchFontWeight: StitchVersionedCodable {
    public init(previousInstance: StitchFontWeight_V31.PreviousInstance) {
