...
public enum StitchSpacing_V31: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V31
    public typealias PreviousInstance = StitchSpacing_V30.StitchSpacing
    // MARK: - end
...
extension StitchSpacing_V31.StitchSpacing: StitchVersionedCodable {
    public init(previousInstance: StitchSpacing_V31.PreviousInstance) {
