...
public enum StitchStringValue_V31: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V31
    public typealias PreviousInstance = StitchStringValue_V30.StitchStringValue
    // MARK: - end
...
extension StitchStringValue_V31.StitchStringValue: StitchVersionedCodable {
    public init(previousInstance: StitchStringValue_V31.PreviousInstance) {
