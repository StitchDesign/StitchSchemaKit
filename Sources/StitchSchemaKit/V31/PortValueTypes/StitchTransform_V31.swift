...
public enum StitchTransform_V31: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V31
    public typealias PreviousInstance = StitchTransform_V30.StitchTransform
    // MARK: - endif
...
extension StitchTransform_V31.StitchTransform: StitchVersionedCodable {
    public init(previousInstance: StitchTransform_V31.PreviousInstance) {
