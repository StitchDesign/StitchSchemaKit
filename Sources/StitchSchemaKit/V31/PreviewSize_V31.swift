...
public enum PreviewSize_V31: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V31
    public typealias PreviousInstance = PreviewSize_V30.PreviewSize
    // MARK: - endif
...
extension PreviewSize_V31.PreviewSize: StitchVersionedCodable {
    public init(previousInstance: PreviewSize_V31.PreviousInstance) {
