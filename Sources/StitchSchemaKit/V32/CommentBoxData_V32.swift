...
public enum CommentBoxData_V32: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V32
    public typealias PreviousInstance = CommentBoxData_V31.CommentBoxData
    public typealias CanvasItemId = CanvasItemId_V32.CanvasItemId
    // MARK: - endif
...
extension CommentBoxData_V32.CommentBoxData: StitchVersionedCodable {
    public init(previousInstance: CommentBoxData_V32.PreviousInstance) {
