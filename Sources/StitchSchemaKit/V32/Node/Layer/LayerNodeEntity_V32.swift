...
public enum LayerNodeEntity_V32: StitchSchemaVersionable {

    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V32
    public typealias PreviousInstance = LayerNodeEntity_V31.LayerNodeEntity
    public typealias CanvasNodeEntity = CanvasNodeEntity_V32.CanvasNodeEntity
    public typealias Layer = Layer_V32.Layer
    public typealias LayerInputEntity = LayerInputEntity_V32.LayerInputEntity
...
extension LayerNodeEntity_V32.LayerNodeEntity: StitchVersionedCodable {
    public init(previousInstance: LayerNodeEntity_V32.PreviousInstance) {
        self.init(id: previousInstance.id,
                  layer: LayerNodeEntity_V32.Layer(previousInstance: previousInstance.layer),
                  ...
                  sizePort: LayerNodeEntity_V32.LayerInputEntity(previousInstance: previousInstance.sizePort),
