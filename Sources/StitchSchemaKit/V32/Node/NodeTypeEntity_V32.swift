...
public enum NodeTypeEntity_V32: StitchSchemaVersionable {

    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V32
    public typealias PreviousInstance = NodeTypeEntity_V31.NodeTypeEntity
    // MARK: - end

    public enum NodeTypeEntity: Hashable {
        case patch(PatchNodeEntity_V32.PatchNodeEntity)
        case layer(LayerNodeEntity_V32.LayerNodeEntity)
        case group(CanvasNodeEntity_V32.CanvasNodeEntity)
        case component(ComponentEntity_V32.ComponentEntity)
    }
}

extension NodeTypeEntity_V32.NodeTypeEntity {
    public var kind: NodeKind_V32.NodeKind {
        switch self {
    ...
    var patchNodeEntity: PatchNodeEntity_V32.PatchNodeEntity? {
        switch self {
    ...
    func inputsModifier(callback: @escaping (NodeConnectionType_V32.NodeConnectionType) -> NodeConnectionType_V32.NodeConnectionType) -> Self {
        switch self {
        ...
        case .layer(var layerNodeEntity):
            let allPorts = LayerInputPort_V32.LayerInputPort.allCases
...
extension NodeTypeEntity_V32.NodeTypeEntity: StitchVersionedCodable {
    public init(previousInstance: NodeTypeEntity_V32.PreviousInstance) {
