...
public enum Anchoring_V32: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V32
    public typealias PreviousInstance = Anchoring_V31.Anchoring
    // MARK: - endif
...
extension Anchoring_V32.Anchoring: StitchVersionedCodable {
    public init(previousInstance: Anchoring_V32.PreviousInstance) {
