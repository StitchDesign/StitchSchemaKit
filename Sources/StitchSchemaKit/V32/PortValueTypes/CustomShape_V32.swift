...
public enum CustomShape_V32: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V32
    public typealias PreviousInstance = CustomShape_V31.CustomShape
    public typealias ShapeAndRect = ShapeAndRect_V32.ShapeAndRect
...
extension CustomShape_V32.CustomShape: StitchVersionedCodable {
    public init(previousInstance: CustomShape_V32.PreviousInstance) {
