...
public enum JSONCurveTo_V32: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V32
    public typealias PreviousInstance = JSONCurveTo_V31.JSONCurveTo
    // MARK: - endif
...
extension JSONCurveTo_V32.JSONCurveTo: StitchVersionedCodable {
    public init(previousInstance: JSONCurveTo_V32.PreviousInstance) {
