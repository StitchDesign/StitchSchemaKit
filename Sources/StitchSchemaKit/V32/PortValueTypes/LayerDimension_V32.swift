...
public enum LayerDimension_V32: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V32
    public typealias PreviousInstance = LayerDimension_V31.LayerDimension
    // MARK: - endif
...
extension LayerDimension_V32.LayerDimension: StitchVersionedCodable {
    public init(previousInstance: LayerDimension_V32.PreviousInstance) {
