...
public enum LayerSize_V32: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V32
    public typealias PreviousInstance = LayerSize_V31.LayerSize
...
extension LayerSize_V32.LayerSize: StitchVersionedCodable {
    public init(previousInstance: LayerSize_V32.PreviousInstance) {
