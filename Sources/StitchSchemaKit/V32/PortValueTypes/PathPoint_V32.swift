...
public enum PathPoint_V32: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V32
    public typealias PreviousInstance = PathPoint_V31.PathPoint
    // MARK: - endif
...
extension PathPoint_V32.PathPoint: StitchVersionedCodable {
    public init(previousInstance: PathPoint_V32.PreviousInstance) {
