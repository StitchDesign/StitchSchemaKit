...
public enum RGBA_V32: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V32
    public typealias PreviousInstance = RGBA_V31.RGBA
    // MARK: - endif
...
extension RGBA_V32.RGBA: StitchVersionedCodable {
    public init(previousInstance: RGBA_V32.PreviousInstance) {
