...
public enum ShapeCommand_V32: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V32
    public typealias PreviousInstance = ShapeCommand_V31.ShapeCommand
    public typealias PathPoint = PathPoint_V32.PathPoint
    // MARK: - endif
...
extension ShapeCommand_V32.ShapeCommand: StitchVersionedCodable {
    public init(previousInstance: ShapeCommand_V32.PreviousInstance) {
...
extension ShapeCommand_V32.ShapeCommand: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        case .lineTo:
            let point = try container.decode(PathPoint_V32.PathPoint.self, forKey: .point)
        ...
        case .curveTo:
            ...
            let curveFrom = try container.decode(PathPoint_V32.PathPoint.self, forKey: .curveFrom)
            let curveTo = try container.decode(PathPoint_V32.PathPoint.self, forKey: .curveTo)
