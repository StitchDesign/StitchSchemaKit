...
public enum SidebarLayerData_V32: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V32
    public typealias PreviousInstance = SidebarLayerData_V31.SidebarLayerData
    // MARK: - endif
...
extension SidebarLayerData_V32.SidebarLayerData: StitchVersionedCodable {
    public init(previousInstance: SidebarLayerData_V32.PreviousInstance) {
