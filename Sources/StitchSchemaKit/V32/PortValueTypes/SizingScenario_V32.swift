...
public enum SizingScenario_V32: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V32
    public typealias PreviousInstance = SizingScenario_V31.SizingScenario
    // MARK: - end
...
extension SizingScenario_V32.SizingScenario: StitchVersionedCodable {
    public init(previousInstance: SizingScenario_V32.PreviousInstance) {
