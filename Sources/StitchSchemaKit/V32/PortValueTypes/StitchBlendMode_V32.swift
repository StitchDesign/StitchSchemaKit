...
public enum StitchBlendMode_V32: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V32
    public typealias PreviousInstance = StitchBlendMode_V31.StitchBlendMode
...
extension StitchBlendMode_V32.StitchBlendMode: StitchVersionedCodable {
    public init(previousInstance: StitchBlendMode_V32.PreviousInstance) {
