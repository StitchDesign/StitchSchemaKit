...
public enum StitchFontWeight_V32: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V32
    public typealias PreviousInstance = StitchFontWeight_V31.StitchFontWeight
    // MARK: - endif
...
extension StitchFontWeight_V32.StitchFontWeight: StitchVersionedCodable {
    public init(previousInstance: StitchFontWeight_V32.PreviousInstance) {
