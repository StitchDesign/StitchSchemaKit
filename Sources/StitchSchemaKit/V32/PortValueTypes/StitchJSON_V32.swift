...
public enum StitchJSON_V32: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V32
    public typealias PreviousInstance = StitchJSON_V31.StitchJSON
    // MARK: - endif
...
extension StitchJSON_V32.StitchJSON: StitchVersionedCodable {
    public init(previousInstance: StitchJSON_V32.PreviousInstance) {
