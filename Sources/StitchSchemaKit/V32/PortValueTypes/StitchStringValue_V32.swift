...
public enum StitchStringValue_V32: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V32
    public typealias PreviousInstance = StitchStringValue_V31.StitchStringValue
    // MARK: - end
...
extension StitchStringValue_V32.StitchStringValue: StitchVersionedCodable {
    public init(previousInstance: StitchStringValue_V32.PreviousInstance) {
