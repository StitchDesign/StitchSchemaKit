...
public enum StitchTransform_V32: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V32
    public typealias PreviousInstance = StitchTransform_V31.StitchTransform
    // MARK: - endif
...
extension StitchTransform_V32.StitchTransform: StitchVersionedCodable {
    public init(previousInstance: StitchTransform_V32.PreviousInstance) {
