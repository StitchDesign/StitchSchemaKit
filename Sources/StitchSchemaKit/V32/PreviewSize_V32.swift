...
public enum PreviewSize_V32: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V32
    public typealias PreviousInstance = PreviewSize_V31.PreviewSize
    // MARK: - endif
...
extension PreviewSize_V32.PreviewSize: StitchVersionedCodable {
    public init(previousInstance: PreviewSize_V32.PreviousInstance) {
