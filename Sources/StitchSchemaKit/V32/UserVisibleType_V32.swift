...
public enum UserVisibleType_V32: StitchSchemaVersionable {
...
extension UserVisibleType_V32.UserVisibleType: StitchVersionedCodable {
    public init(previousInstance: UserVisibleType_V32.PreviousInstance) {
