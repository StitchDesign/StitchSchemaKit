...
public enum CustomShape_V4: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V4
    public typealias PreviousInstance = CustomShape_V3.CustomShape
...
extension CustomShape_V4.CustomShape: StitchVersionedCodable {
    public init(previousInstance: CustomShape_V4.PreviousInstance) {
