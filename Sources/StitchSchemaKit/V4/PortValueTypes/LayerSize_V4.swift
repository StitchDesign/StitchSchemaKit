...
public enum LayerSize_V4: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V4
    public typealias PreviousInstance = LayerSize_V3.LayerSize
    // MARK: - endif
...
extension LayerSize_V4.LayerSize: StitchVersionedCodable {
    public init(previousInstance: LayerSize_V4.PreviousInstance) {
