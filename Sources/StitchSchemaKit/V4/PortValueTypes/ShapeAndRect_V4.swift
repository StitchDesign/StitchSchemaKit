...
public enum ShapeAndRect_V4: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V4
    public typealias PreviousInstance = ShapeAndRect_V3.ShapeAndRect
...
extension ShapeAndRect_V4.ShapeAndRect: StitchVersionedCodable {
    public init(previousInstance: ShapeAndRect_V4.PreviousInstance) {
