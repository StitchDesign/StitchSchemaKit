...
public enum ShapeCommand_V4: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V4
    public typealias PreviousInstance = ShapeCommand_V3.ShapeCommand
    // MARK: - endif
...
extension ShapeCommand_V4.ShapeCommand: StitchVersionedCodable {
    public init(previousInstance: ShapeCommand_V4.PreviousInstance) {
...
extension ShapeCommand_V4.ShapeCommand: Codable {
