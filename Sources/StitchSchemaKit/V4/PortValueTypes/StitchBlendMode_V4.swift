...
public enum StitchBlendMode_V4: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V4
    public typealias PreviousInstance = StitchBlendMode_V3.StitchBlendMode
...
extension StitchBlendMode_V4.StitchBlendMode: StitchVersionedCodable {
    public init(previousInstance: StitchBlendMode_V4.PreviousInstance) {
