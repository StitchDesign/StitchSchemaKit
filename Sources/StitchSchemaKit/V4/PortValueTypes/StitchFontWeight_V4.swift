...
public enum StitchFontWeight_V4: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V4
    public typealias PreviousInstance = StitchFontWeight_V3.StitchFontWeight
    // MARK: - endif
...
extension StitchFontWeight_V4.StitchFontWeight: StitchVersionedCodable {
    public init(previousInstance: StitchFontWeight_V4.PreviousInstance) {
