...
public enum TriangleData_V4: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V4
    public typealias PreviousInstance = TriangleData_V3.TriangleData
    // MARK: - endif
...
extension TriangleData_V4.TriangleData: StitchVersionedCodable {
    public init(previousInstance: TriangleData_V4.PreviousInstance) {
