...
public enum PreviewSize_V4: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V4
    public typealias PreviousInstance = PreviewSize_V3.PreviewSize
    // MARK: - endif
...
extension PreviewSize_V4.PreviewSize: StitchVersionedCodable {
    public init(previousInstance: PreviewSize_V4.PreviousInstance) {
