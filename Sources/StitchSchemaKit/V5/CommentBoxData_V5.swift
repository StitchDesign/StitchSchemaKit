...
public enum CommentBoxData_V5: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V5
    public typealias PreviousInstance = CommentBoxData_V4.CommentBoxData
    // MARK: - endif
...
extension CommentBoxData_V5.CommentBoxData: StitchVersionedCodable {
    public init(previousInstance: CommentBoxData_V5.PreviousInstance) {
