...
public enum StitchDocument_V5: StitchSchemaVersionable {

    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V5
    public typealias PreviousInstance = StitchDocument_V4.StitchDocument
    public typealias NodeEntitySchemas = [NodeEntity_V5.NodeEntity]
    public typealias CommentBoxes = [CommentBoxData_V5.CommentBoxData]
    public typealias PreviewSize = PreviewSize_V5.PreviewSize
    public typealias SidebarLayerDataList = [SidebarLayerData_V5.SidebarLayerData]
    public typealias CameraSettings = CameraSettings_V5.CameraSettings
    // MARK: - end
...
extension StitchDocument_V5.StitchDocument {
    public init(previousInstance: StitchDocument_V5.PreviousInstance) {
        self.init(
            projectId: previousInstance.projectId,
            name: previousInstance.name,
            previewWindowSize: previousInstance.previewWindowSize,
            previewSizeDevice: PreviewSize_V5.PreviewSize(previousInstance: previousInstance.previewSizeDevice),
            ...
            nodes: StitchDocument_V5.NodeEntitySchemas(previousElements: previousInstance.nodes),
            orderedSidebarLayers: StitchDocument_V5.SidebarLayerDataList(previousElements: previousInstance.orderedSidebarLayers),
            commentBoxes: StitchDocument_V5.CommentBoxes(previousElements: previousInstance.commentBoxes),
            cameraSettings: StitchDocument_V5.CameraSettings(previousInstance: previousInstance.cameraSettings)
        )
    }
}
