...
public enum Patch_V5: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V5
    public typealias PreviousInstance = Patch_V4.Patch
    // MARK: - endif
...
extension Patch_V5.Patch: StitchVersionedCodable {
    public init(previousInstance: Patch_V5.PreviousInstance) {
