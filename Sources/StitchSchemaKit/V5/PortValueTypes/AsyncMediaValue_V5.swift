...
public enum AsyncMediaValue_V5: StitchSchemaVersionable {
    ...
    public struct AsyncMediaValue: Codable, Equatable, Hashable {
        ...
        public var dataType: DataType_V5.DataType<MediaKey_V5.MediaKey>
        
        public init(id: MediaObjectId, dataType: DataType_V5.DataType<MediaKey_V5.MediaKey>) {
            self.id = id
        ...
        public init(globalId: UUID, nodeId: NodeId, mediaKey: MediaKey_V5.MediaKey) {
...
extension AsyncMediaValue_V5.AsyncMediaValue: StitchVersionedCodable {
    public init(previousInstance: AsyncMediaValue_V5.PreviousInstance) {
        
        var dataType: DataType_V5.DataType<MediaKey_V5.MediaKey>
