...
public enum CustomShape_V5: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V5
    public typealias PreviousInstance = CustomShape_V4.CustomShape
...
extension CustomShape_V5.CustomShape: StitchVersionedCodable {
    public init(previousInstance: CustomShape_V5.PreviousInstance) {
