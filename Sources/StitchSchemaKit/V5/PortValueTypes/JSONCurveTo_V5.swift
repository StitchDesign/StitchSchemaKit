...
public enum JSONCurveTo_V5: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V5
    public typealias PreviousInstance = JSONCurveTo_V4.JSONCurveTo
    // MARK: - endif
...
extension JSONCurveTo_V5.JSONCurveTo: StitchVersionedCodable {
    public init(previousInstance: JSONCurveTo_V5.PreviousInstance) {
