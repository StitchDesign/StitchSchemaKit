...
public enum JSONShapeCommand_V5: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V5
    public typealias PreviousInstance = JSONShapeCommand_V4.JSONShapeCommand
    public typealias JSONCurveTo = JSONCurveTo_V5.JSONCurveTo
    // MARK: - endif
...
extension JSONShapeCommand_V5.JSONShapeCommand: StitchVersionedCodable {
    public init(previousInstance: JSONShapeCommand_V5.PreviousInstance) {
        ...
        case .curveTo(let value):
            self = .curveTo(JSONShapeCommand_V5.JSONCurveTo(previousInstance: value))
        }
    }
}
