...
public enum JSONShapeKeys_V5: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V5
    public typealias PreviousInstance = JSONShapeKeys_V4.JSONShapeKeys
    // MARK: - endif
...
extension JSONShapeKeys_V5.JSONShapeKeys: StitchVersionedCodable {
    public init(previousInstance: JSONShapeKeys_V5.PreviousInstance) {
        fatalError()
    }
}
