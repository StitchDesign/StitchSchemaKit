...
public enum LayerSize_V5: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V5
    public typealias PreviousInstance = LayerSize_V4.LayerSize
...
extension LayerSize_V5.LayerSize: StitchVersionedCodable {
    public init(previousInstance: LayerSize_V5.PreviousInstance) {
