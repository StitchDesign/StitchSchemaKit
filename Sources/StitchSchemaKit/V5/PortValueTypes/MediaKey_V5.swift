...
public enum MediaKey_V5: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V5
    public typealias PreviousInstance = MediaKey_V4.MediaKey
    // MARK: - endif
...
extension MediaKey_V5.MediaKey: StitchVersionedCodable {
    public init(previousInstance: MediaKey_V5.PreviousInstance) {
