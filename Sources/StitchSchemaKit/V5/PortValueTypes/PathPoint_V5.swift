...
public enum PathPoint_V5: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V5
    public typealias PreviousInstance = PathPoint_V4.PathPoint
    // MARK: - endif
...
extension PathPoint_V5.PathPoint: StitchVersionedCodable {
    public init(previousInstance: PathPoint_V5.PreviousInstance) {
