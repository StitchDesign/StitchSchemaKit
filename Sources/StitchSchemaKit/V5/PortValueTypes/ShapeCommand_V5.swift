...
public enum ShapeCommand_V5: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V5
    public typealias PreviousInstance = ShapeCommand_V4.ShapeCommand
...
extension ShapeCommand_V5.ShapeCommand: StitchVersionedCodable {
    public init(previousInstance: ShapeCommand_V5.PreviousInstance) {
...
extension ShapeCommand_V5.ShapeCommand: Codable {
