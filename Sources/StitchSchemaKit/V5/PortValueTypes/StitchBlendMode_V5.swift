...
public enum StitchBlendMode_V5: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V5
    public typealias PreviousInstance = StitchBlendMode_V4.StitchBlendMode
...
extension StitchBlendMode_V5.StitchBlendMode: StitchVersionedCodable {
    public init(previousInstance: StitchBlendMode_V5.PreviousInstance) {
