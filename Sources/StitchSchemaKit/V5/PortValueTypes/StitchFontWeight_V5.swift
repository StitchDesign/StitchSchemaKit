...
public enum StitchFontWeight_V5: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V5
    public typealias PreviousInstance = StitchFontWeight_V4.StitchFontWeight
    // MARK: - endif
...
extension StitchFontWeight_V5.StitchFontWeight: StitchVersionedCodable {
    public init(previousInstance: StitchFontWeight_V5.PreviousInstance) {
