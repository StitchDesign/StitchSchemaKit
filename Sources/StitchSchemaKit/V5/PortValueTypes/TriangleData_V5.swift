...
public enum TriangleData_V5: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V5
    public typealias PreviousInstance = TriangleData_V4.TriangleData
    // MARK: - endif
...
extension TriangleData_V5.TriangleData: StitchVersionedCodable {
    public init(previousInstance: TriangleData_V5.PreviousInstance) {
