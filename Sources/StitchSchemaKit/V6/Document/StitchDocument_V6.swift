...
public enum StitchDocument_V6: StitchSchemaVersionable {

    // MARK: - ensure versions are correct
    public static let version = StitchSchemaVersion._V6
    public typealias PreviousInstance = StitchDocument_V5.StitchDocument
    public typealias NodeEntitySchemas = [NodeEntity_V6.NodeEntity]
    public typealias CommentBoxes = [CommentBoxData_V6.CommentBoxData]
    public typealias PreviewSize = PreviewSize_V6.PreviewSize
    public typealias SidebarLayerDataList = [SidebarLayerData_V6.SidebarLayerData]
    public typealias CameraSettings = CameraSettings_V6.CameraSettings
    // MARK: - end
...
extension StitchDocument_V6.StitchDocument {
    public init(previousInstance: StitchDocument_V6.PreviousInstance) {
        self.init(
            projectId: previousInstance.projectId,
            name: previousInstance.name,
            previewWindowSize: previousInstance.previewWindowSize,
            previewSizeDevice: PreviewSize_V6.PreviewSize(previousInstance: previousInstance.previewSizeDevice),
            ...
            nodes: StitchDocument_V6.NodeEntitySchemas(previousElements: previousInstance.nodes),
            orderedSidebarLayers: StitchDocument_V6.SidebarLayerDataList(previousElements: previousInstance.orderedSidebarLayers),
            commentBoxes: StitchDocument_V6.CommentBoxes(previousElements: previousInstance.commentBoxes),
            cameraSettings: StitchDocument_V6.CameraSettings(previousInstance: previousInstance.cameraSettings)
        )
    }
}
