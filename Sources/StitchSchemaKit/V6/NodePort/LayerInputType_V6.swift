...
extension LayerInputType_V6.LayerInputType {
    /// Keypath mapping to this schema version.
    public var schemaPortKeyPath: WritableKeyPath<LayerNodeEntity_V6.LayerNodeEntity, NodeConnectionType_V6.NodeConnectionType> {
        switch self {
        case .position:
            return \.positionPort
        case .size:
