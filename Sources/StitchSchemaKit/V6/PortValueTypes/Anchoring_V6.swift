...
public enum Anchoring_V6: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V6
    public typealias PreviousInstance = Anchoring_V5.Anchoring
    // MARK: - endif
...
extension Anchoring_V6.Anchoring: StitchVersionedCodable {
    public init(previousInstance: Anchoring_V6.PreviousInstance) {
