...
public enum CustomShape_V6: StitchSchemaVersionable {
...
extension CustomShape_V6.CustomShape: StitchVersionedCodable {
    public init(previousInstance: CustomShape_V6.PreviousInstance) {
