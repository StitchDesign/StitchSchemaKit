...
public enum JSONCurveTo_V6: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V6
    public typealias PreviousInstance = JSONCurveTo_V5.JSONCurveTo
    // MARK: - endif
...
extension JSONCurveTo_V6.JSONCurveTo: StitchVersionedCodable {
    public init(previousInstance: JSONCurveTo_V6.PreviousInstance) {
