...
public enum JSONShapeCommand_V6: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V6
    public typealias PreviousInstance = JSONShapeCommand_V5.JSONShapeCommand
    public typealias JSONCurveTo = JSONCurveTo_V6.JSONCurveTo
    // MARK: - endif
...
extension JSONShapeCommand_V6.JSONShapeCommand: StitchVersionedCodable {
    public init(previousInstance: JSONShapeCommand_V6.PreviousInstance) {
        ...
        case .curveTo(let value):
            self = .curveTo(JSONShapeCommand_V6.JSONCurveTo(previousInstance: value))
        }
    }
}
