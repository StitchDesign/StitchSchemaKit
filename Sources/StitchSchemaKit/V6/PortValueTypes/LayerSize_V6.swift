...
public enum LayerSize_V6: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V6
    public typealias PreviousInstance = LayerSize_V5.LayerSize
    // MARK: - endif
...
extension LayerSize_V6.LayerSize: StitchVersionedCodable {
    public init(previousInstance: LayerSize_V6.PreviousInstance) {
