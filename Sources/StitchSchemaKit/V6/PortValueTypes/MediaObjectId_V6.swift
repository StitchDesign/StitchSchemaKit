...
public enum MediaObjectId_V6: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V6
    public typealias PreviousInstance = MediaObjectId_V5.MediaObjectId
    // MARK: - endif
...
extension MediaObjectId_V6.MediaObjectId: StitchVersionedCodable {
    public init(previousInstance: MediaObjectId_V6.PreviousInstance) {
