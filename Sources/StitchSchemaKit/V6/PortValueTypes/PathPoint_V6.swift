...
public enum PathPoint_V6: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V6
    public typealias PreviousInstance = PathPoint_V5.PathPoint
    // MARK: - endif
...
extension PathPoint_V6.PathPoint: StitchVersionedCodable {
    public init(previousInstance: PathPoint_V6.PreviousInstance) {
