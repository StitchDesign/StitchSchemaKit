...
public enum ShapeCommand_V6: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V6
    public typealias PreviousInstance = ShapeCommand_V5.ShapeCommand
    // MARK: - endif
...
extension ShapeCommand_V6.ShapeCommand: StitchVersionedCodable {
    public init(previousInstance: ShapeCommand_V6.PreviousInstance) {
...
extension ShapeCommand_V6.ShapeCommand: Codable {
