...
public enum StitchBlendMode_V6: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V6
    public typealias PreviousInstance = StitchBlendMode_V5.StitchBlendMode
...
extension StitchBlendMode_V6.StitchBlendMode: StitchVersionedCodable {
    public init(previousInstance: StitchBlendMode_V6.PreviousInstance) {
