...
public enum StitchFontWeight_V6: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V6
    public typealias PreviousInstance = StitchFontWeight_V5.StitchFontWeight
    // MARK: - endif
...
extension StitchFontWeight_V6.StitchFontWeight: StitchVersionedCodable {
    public init(previousInstance: StitchFontWeight_V6.PreviousInstance) {
