...
public enum StitchMapType_V6: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V6
    public typealias PreviousInstance = StitchMapType_V5.StitchMapType
...
extension StitchMapType_V6.StitchMapType: StitchVersionedCodable {
    public init(previousInstance: StitchMapType_V6.PreviousInstance) {
