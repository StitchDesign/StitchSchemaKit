...
public enum UserVisibleType_V6: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V6
    public typealias PreviousInstance = UserVisibleType_V5.UserVisibleType
    // MARK: - endif
...
extension UserVisibleType_V6.UserVisibleType: StitchVersionedCodable {
    public init(previousInstance: UserVisibleType_V6.PreviousInstance) {
