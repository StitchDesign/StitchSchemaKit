...
public enum CommentBoxData_V7: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V7
    public typealias PreviousInstance = CommentBoxData_V6.CommentBoxData
    // MARK: - endif
...
extension CommentBoxData_V7.CommentBoxData: StitchVersionedCodable {
    public init(previousInstance: CommentBoxData_V7.PreviousInstance) {
