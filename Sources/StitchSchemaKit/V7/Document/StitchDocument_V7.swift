...
public enum StitchDocument_V7: StitchSchemaVersionable {

    // MARK: - ensure versions are correct
    static let version = StitchSchemaVersion._V7
    public typealias PreviousInstance = StitchDocument_V6.StitchDocument
    public typealias NodeEntitySchemas = [NodeEntity_V7.NodeEntity]
    public typealias CommentBoxes = [CommentBoxData_V7.CommentBoxData]
    public typealias PreviewSize = PreviewSize_V7.PreviewSize
    public typealias SidebarLayerDataList = [SidebarLayerData_V7.SidebarLayerData]
    public typealias CameraSettings = CameraSettings_V7.CameraSettings
    // MARK: - end
...
extension StitchDocument_V7.StitchDocument {
    public init(previousInstance: StitchDocument_V7.PreviousInstance) {
        self.init(
            projectId: previousInstance.projectId,
            name: previousInstance.name,
            previewWindowSize: previousInstance.previewWindowSize,
            previewSizeDevice: PreviewSize_V7.PreviewSize(previousInstance: previousInstance.previewSizeDevice),
            ...
            nodes: StitchDocument_V7.NodeEntitySchemas(previousElements: previousInstance.nodes),
            orderedSidebarLayers: StitchDocument_V7.SidebarLayerDataList(previousElements: previousInstance.orderedSidebarLayers),
            commentBoxes: StitchDocument_V7.CommentBoxes(previousElements: previousInstance.commentBoxes),
            cameraSettings: StitchDocument_V7.CameraSettings(previousInstance: previousInstance.cameraSettings)
        )
    }
}
