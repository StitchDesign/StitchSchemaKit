...
public enum LayerNodeEntity_V7: StitchSchemaVersionable {

    // MARK: - ensure versions are correct
    static var version = StitchSchemaVersion._V7
    public typealias PreviousInstance = LayerNodeEntity_V6.LayerNodeEntity
    public typealias NodeEntitySchema = NodeEntity_V7
    public typealias Layer = Layer_V7.Layer
    public typealias NodeConnectionType = NodeConnectionType_V7.NodeConnectionType
    // MARK: - end
...
extension LayerNodeEntity_V7.LayerNodeEntity: StitchVersionedCodable {
    public init(previousInstance: LayerNodeEntity_V7.PreviousInstance) {
        self.init(id: previousInstance.id,
                  layer:
                    LayerNodeEntity_V7.Layer(previousInstance: previousInstance.layer),
                  
                  // Empty values that we correct in the running app
                  positionPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.positionPort),
                  sizePort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.sizePort),
                  scalePort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.scalePort),
                  anchoringPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.anchoringPort),
                  opacityPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.opacityPort),
                  zIndexPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.zIndexPort),
                  colorPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.colorPort),
                  rotationXPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.rotationXPort),
                  rotationYPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.rotationYPort),
                  rotationZPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.rotationZPort),
                  lineColorPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.lineColorPort),
                  lineWidthPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.lineWidthPort),
                  blurPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.blurPort),
                  blendModePort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.blendModePort),
                  brightnessPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.brightnessPort),
                  colorInvertPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.colorInvertPort),
                  contrastPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.contrastPort),
                  hueRotationPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.hueRotationPort),
                  saturationPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.saturationPort),
                  pivotPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.pivotPort),
                  enabledPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.enabledPort),
                  blurRadiusPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.blurRadiusPort),
                  backgroundColorPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.backgroundColorPort),
                  isClippedPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.isClippedPort),
                  orientationPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.orientationPort),
                  paddingPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.paddingPort),
                  setupModePort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.setupModePort),
                  allAnchorsPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.allAnchorsPort),
                  cameraDirectionPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.cameraDirectionPort),
                  isCameraEnabledPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.isCameraEnabledPort),
                  isShadowsEnabledPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.isShadowsEnabledPort),
                  shapePort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.shapePort),
                  strokePositionPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.strokePositionPort),
                  strokeWidthPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.strokeWidthPort),
                  strokeColorPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.strokeColorPort),
                  coordinateSystemPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.coordinateSystemPort),
                  cornerRadiusPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.cornerRadiusPort),
                  canvasLineColorPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.canvasLineColorPort),
                  canvasLineWidthPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.canvasLineWidthPort),
                  canvasPositionPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.canvasPositionPort),
                  textPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.textPort),
                  fontSizePort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.fontSizePort),
                  textAlignmentPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.textAlignmentPort),
                  verticalAlignmentPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.verticalAlignmentPort),
                  textDecorationPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.textDecorationPort),
                  textFontPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.textFontPort),
                  imagePort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.imagePort),
                  videoPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.videoPort),
                  fitStylePort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.fitStylePort),
                  clippedPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.clippedPort),
                  isAnimatingPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.isAnimatingPort),
                  progressIndicatorStylePort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.progressIndicatorStylePort),
                  progressPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.progressPort),
                  model3DPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.model3DPort),
                  mapTypePort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.mapTypePort),
                  mapLatLongPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.mapLatLongPort),
                  mapSpanPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.mapSpanPort),
                  isSwitchToggledPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.isSwitchToggledPort),
                  placeholderTextPort: NodeConnectionType_V7.NodeConnectionType(previousInstance: previousInstance.placeholderTextPort),
