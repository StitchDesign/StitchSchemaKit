...
extension NodeEntity_V7.NodeEntity: StitchVersionedCodable {
    public init(previousInstance: NodeEntity_V7.PreviousInstance) {
        var migratedLayerEntity: LayerNodeEntity_V7.LayerNodeEntity?
        let migratedInputs = NodeEntity_V7.NodePortInputEntitySchemas(previousElements: previousInstance.inputs)
        ...
        if let prevLayerEntity = previousInstance.layerNodeEntity {
            var _migratedLayerEntity = NodeEntity_V7.LayerNodeEntitySchema(previousInstance: prevLayerEntity)
        ...
        self.init(
            ...
            patchNodeEntity:
                NodeEntity_V7.PatchNodeEntitySchema(previousInstance: previousInstance.patchNodeEntity),
    ...
    private static func layerInputs(for layer: Layer_V6.Layer) -> [LayerInputType_V7.LayerInputType] {
        switch layer {
        case .text:
            return [
                .text,
