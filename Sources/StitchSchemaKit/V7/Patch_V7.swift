...
public enum Patch_V7: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V7
    public typealias PreviousInstance = Patch_V6.Patch
    // MARK: - endif
...
extension Patch_V7.Patch: StitchVersionedCodable {
    public init(previousInstance: Patch_V7.PreviousInstance) {
