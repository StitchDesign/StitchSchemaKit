...
public enum Anchoring_V7: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V7
    public typealias PreviousInstance = Anchoring_V6.Anchoring
    // MARK: - endif
...
extension Anchoring_V7.Anchoring: StitchVersionedCodable {
    public init(previousInstance: Anchoring_V7.PreviousInstance) {
