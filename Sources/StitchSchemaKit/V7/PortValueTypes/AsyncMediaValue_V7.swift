...
public enum AsyncMediaValue_V7: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V7
    public typealias PreviousInstance = AsyncMediaValue_V6.AsyncMediaValue
    ...
    public struct AsyncMediaValue: Codable, Equatable, Hashable {
        ...
        public var dataType: DataType_V7.DataType<MediaKey_V7.MediaKey>
        
        public init(id: MediaObjectId, dataType: DataType_V7.DataType<MediaKey_V7.MediaKey>) {
            self.id = id
        ...
        public init(globalId: UUID, nodeId: NodeId, mediaKey: MediaKey_V7.MediaKey) {
...
extension AsyncMediaValue_V7.AsyncMediaValue: StitchVersionedCodable {
    public init(previousInstance: AsyncMediaValue_V7.PreviousInstance) {
        
        var dataType: DataType_V7.DataType<MediaKey_V7.MediaKey>
