...
public enum CustomShape_V7: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V7
    public typealias PreviousInstance = CustomShape_V6.CustomShape
...
extension CustomShape_V7.CustomShape: StitchVersionedCodable {
    public init(previousInstance: CustomShape_V7.PreviousInstance) {
