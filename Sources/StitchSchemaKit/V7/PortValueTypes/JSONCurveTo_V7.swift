...
public enum JSONCurveTo_V7: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V7
    public typealias PreviousInstance = JSONCurveTo_V6.JSONCurveTo
    // MARK: - endif
...
extension JSONCurveTo_V7.JSONCurveTo: StitchVersionedCodable {
    public init(previousInstance: JSONCurveTo_V7.PreviousInstance) {
