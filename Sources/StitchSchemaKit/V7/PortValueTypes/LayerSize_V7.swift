...
public enum LayerSize_V7: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V7
    public typealias PreviousInstance = LayerSize_V6.LayerSize
...
extension LayerSize_V7.LayerSize: StitchVersionedCodable {
    public init(previousInstance: LayerSize_V7.PreviousInstance) {
