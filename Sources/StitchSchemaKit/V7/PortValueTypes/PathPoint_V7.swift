...
public enum PathPoint_V7: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V7
    public typealias PreviousInstance = PathPoint_V6.PathPoint
    // MARK: - endif
...
extension PathPoint_V7.PathPoint: StitchVersionedCodable {
    public init(previousInstance: PathPoint_V7.PreviousInstance) {
