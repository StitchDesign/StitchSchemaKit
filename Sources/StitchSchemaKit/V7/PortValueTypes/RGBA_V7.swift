...
public enum RGBA_V7: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V7
    public typealias PreviousInstance = RGBA_V6.RGBA
    // MARK: - endif
...
extension RGBA_V7.RGBA: StitchVersionedCodable {
    public init(previousInstance: RGBA_V7.PreviousInstance) {
