...
public enum ShapeCommand_V7: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V7
    public typealias PreviousInstance = ShapeCommand_V6.ShapeCommand
    // MARK: - endif
...
extension ShapeCommand_V7.ShapeCommand: StitchVersionedCodable {
    public init(previousInstance: ShapeCommand_V7.PreviousInstance) {
...
extension ShapeCommand_V7.ShapeCommand: Codable {
