...
public enum StitchFontWeight_V7: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V7
    public typealias PreviousInstance = StitchFontWeight_V6.StitchFontWeight
    // MARK: - endif
...
extension StitchFontWeight_V7.StitchFontWeight: StitchVersionedCodable {
    public init(previousInstance: StitchFontWeight_V7.PreviousInstance) {
