...
public enum TriangleData_V7: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V7
    public typealias PreviousInstance = TriangleData_V6.TriangleData
    // MARK: - endif
...
extension TriangleData_V7.TriangleData: StitchVersionedCodable {
    public init(previousInstance: TriangleData_V7.PreviousInstance) {
