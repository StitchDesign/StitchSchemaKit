...
public enum PreviewSize_V7: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V7
    public typealias PreviousInstance = PreviewSize_V6.PreviewSize
    // MARK: - endif
...
extension PreviewSize_V7.PreviewSize: StitchVersionedCodable {
    public init(previousInstance: PreviewSize_V7.PreviousInstance) {
