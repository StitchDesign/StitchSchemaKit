...
public enum UserVisibleType_V7: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V7
    public typealias PreviousInstance = UserVisibleType_V6.UserVisibleType
    // MARK: - endif
...
extension UserVisibleType_V7.UserVisibleType: StitchVersionedCodable {
    public init(previousInstance: UserVisibleType_V7.PreviousInstance) {
