...
public enum Patch_V8: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V8
    public typealias PreviousInstance = Patch_V7.Patch
    // MARK: - endif
...
extension Patch_V8.Patch: StitchVersionedCodable {
    public init(previousInstance: Patch_V8.PreviousInstance) {
