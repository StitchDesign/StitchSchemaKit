...
public enum Anchoring_V8: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V8
    public typealias PreviousInstance = Anchoring_V7.Anchoring
    // MARK: - endif
...
extension Anchoring_V8.Anchoring: StitchVersionedCodable {
    public init(previousInstance: Anchoring_V8.PreviousInstance) {
