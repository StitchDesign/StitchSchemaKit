...
public enum CustomShape_V8: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V8
    public typealias PreviousInstance = CustomShape_V7.CustomShape
    // MARK: - endif
...
extension CustomShape_V8.CustomShape: StitchVersionedCodable {
    public init(previousInstance: CustomShape_V8.PreviousInstance) {
