...
public enum LayerDimension_V8: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V8
    public typealias PreviousInstance = LayerDimension_V7.LayerDimension
    // MARK: - endif
...
extension LayerDimension_V8.LayerDimension: StitchVersionedCodable {
    public init(previousInstance: LayerDimension_V8.PreviousInstance) {
