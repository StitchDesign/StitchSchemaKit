...
public enum LayerSize_V8: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V8
    public typealias PreviousInstance = LayerSize_V7.LayerSize
    // MARK: - endif
...
extension LayerSize_V8.LayerSize: StitchVersionedCodable {
    public init(previousInstance: LayerSize_V8.PreviousInstance) {
