...
public enum PathPoint_V8: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V8
    public typealias PreviousInstance = PathPoint_V7.PathPoint
    // MARK: - endif
...
extension PathPoint_V8.PathPoint: StitchVersionedCodable {
    public init(previousInstance: PathPoint_V8.PreviousInstance) {
