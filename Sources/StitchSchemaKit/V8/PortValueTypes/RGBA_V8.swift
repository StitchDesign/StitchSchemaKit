...
public enum RGBA_V8: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V8
    public typealias PreviousInstance = RGBA_V7.RGBA
    // MARK: - endif
...
extension RGBA_V8.RGBA: StitchVersionedCodable {
    public init(previousInstance: RGBA_V8.PreviousInstance) {
