...
public enum StitchBlendMode_V8: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V8
    public typealias PreviousInstance = StitchBlendMode_V7.StitchBlendMode
...
extension StitchBlendMode_V8.StitchBlendMode: StitchVersionedCodable {
    public init(previousInstance: StitchBlendMode_V8.PreviousInstance) {
