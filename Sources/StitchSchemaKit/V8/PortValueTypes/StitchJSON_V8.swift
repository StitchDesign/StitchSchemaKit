...
public enum StitchJSON_V8: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V8
    public typealias PreviousInstance = StitchJSON_V7.StitchJSON
    // MARK: - endif
...
extension StitchJSON_V8.StitchJSON: StitchVersionedCodable {
    public init(previousInstance: StitchJSON_V8.PreviousInstance) {
