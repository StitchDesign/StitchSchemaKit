...
public enum TriangleData_V8: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V8
    public typealias PreviousInstance = TriangleData_V7.TriangleData
    // MARK: - endif
...
extension TriangleData_V8.TriangleData: StitchVersionedCodable {
    public init(previousInstance: TriangleData_V8.PreviousInstance) {
