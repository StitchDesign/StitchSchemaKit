...
public enum PreviewSize_V8: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V8
    public typealias PreviousInstance = PreviewSize_V7.PreviewSize
    // MARK: - endif
...
extension PreviewSize_V8.PreviewSize: StitchVersionedCodable {
    public init(previousInstance: PreviewSize_V8.PreviousInstance) {
