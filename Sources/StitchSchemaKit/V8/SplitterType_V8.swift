...
public enum SplitterType_V8: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    public static let version: StitchSchemaVersion = StitchSchemaVersion._V8
    public typealias PreviousInstance = SplitterType_V7.SplitterType
    // MARK: - endif
...
extension SplitterType_V8.SplitterType: StitchVersionedCodable {
    public init(previousInstance: SplitterType_V8.PreviousInstance) {
