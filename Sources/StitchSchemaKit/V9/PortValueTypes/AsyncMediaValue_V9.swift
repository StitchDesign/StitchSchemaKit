...
public enum AsyncMediaValue_V9: StitchSchemaVersionable {
    ...
    public struct AsyncMediaValue: Codable, Equatable, Hashable {
        ...
        public var dataType: DataType_V9.DataType<MediaKey_V9.MediaKey>
        
        public init(id: MediaObjectId, dataType: DataType_V9.DataType<MediaKey_V9.MediaKey>) {
            self.id = id
        ...
        public init(globalId: UUID, nodeId: NodeId, mediaKey: MediaKey_V9.MediaKey) {
...
extension AsyncMediaValue_V9.AsyncMediaValue: StitchVersionedCodable {
    public init(previousInstance: AsyncMediaValue_V9.PreviousInstance) {
        ...
        var dataType: DataType_V9.DataType<MediaKey_V9.MediaKey>
