...
public enum CommentBoxData_V18: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V18
    public typealias PreviousInstance = CommentBoxData_V17.CommentBoxData
    // MARK: - endif
...
extension CommentBoxData_V18.CommentBoxData: StitchVersionedCodable {
    public init(previousInstance: CommentBoxData_V18.PreviousInstance) {
