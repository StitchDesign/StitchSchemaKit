...
extension LayerNodeEntity_V19.LayerNodeEntity: StitchVersionedCodable {
    public init(previousInstance: LayerNodeEntity_V19.PreviousInstance) {                
        self.init(id: previousInstance.id,
                  ...
                  anchoringPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.anchoringPort)),
                  opacityPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.opacityPort)),
                  zIndexPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.zIndexPort)),
                  masksPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.masksPort)),
                  colorPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.colorPort)),
                  rotationXPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.rotationXPort)),
                  rotationYPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.rotationYPort)),
                  rotationZPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.rotationZPort)),
                  lineColorPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.lineColorPort)),
                  lineWidthPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.lineWidthPort)),
                  blurPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.blurPort)),
                  blendModePort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.blendModePort)),
                  brightnessPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.brightnessPort)),
                  colorInvertPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.colorInvertPort)),
                  contrastPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.contrastPort)),
                  hueRotationPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.hueRotationPort)),
                  saturationPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.saturationPort)),
                  pivotPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.pivotPort)),
                  enabledPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.enabledPort)),
                  blurRadiusPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.blurRadiusPort)),
                  backgroundColorPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.backgroundColorPort)),
                  isClippedPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.isClippedPort)),
                  orientationPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.orientationPort)),
                  paddingPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.paddingPort)),
                  setupModePort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.setupModePort)),
                  allAnchorsPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.allAnchorsPort)),
                  cameraDirectionPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.cameraDirectionPort)),
                  isCameraEnabledPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.isCameraEnabledPort)),
                  isShadowsEnabledPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.isShadowsEnabledPort)),
                  
                  shapePort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.shapePort)),
                  strokePositionPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.strokePositionPort)),
                  strokeWidthPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.strokeWidthPort)),
                  strokeColorPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.strokeColorPort)),
                  strokeStartPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.strokeStartPort)),
                  strokeEndPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.strokeEndPort)),
                  strokeLineCapPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.strokeLineCapPort)),
                  strokeLineJoinPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.strokeLineJoinPort)),
                  coordinateSystemPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.coordinateSystemPort)),
                  
                  cornerRadiusPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.cornerRadiusPort)),
                  canvasLineColorPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.canvasLineColorPort)),
                  canvasLineWidthPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.canvasLineWidthPort)),
                  canvasPositionPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.canvasPositionPort)),
                  textPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.textPort)),
                  fontSizePort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.fontSizePort)),
                  textAlignmentPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.textAlignmentPort)),
                  verticalAlignmentPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.verticalAlignmentPort)),
                  textDecorationPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.textDecorationPort)),
                  textFontPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.textFontPort)),
                  imagePort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.imagePort)),
                  videoPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.videoPort)),
                  fitStylePort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.fitStylePort)),
                  clippedPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.clippedPort)),
                  isAnimatingPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.isAnimatingPort)),
                  progressIndicatorStylePort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.progressIndicatorStylePort)),
                  progressPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.progressPort)),
                  model3DPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.model3DPort)),
                  mapTypePort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.mapTypePort)),
                  mapLatLongPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.mapLatLongPort)),
                  mapSpanPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.mapSpanPort)),
                  isSwitchToggledPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.isSwitchToggledPort)),
                  placeholderTextPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.placeholderTextPort)),
                  startColorPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.startColorPort)),
                  endColorPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.endColorPort)),
                  startAnchorPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.startAnchorPort)),
                  endAnchorPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.endAnchorPort)),
                  centerAnchorPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.centerAnchorPort)),
                  startAnglePort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.startAnglePort)),
                  endAnglePort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.endAnglePort)),
                  startRadiusPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.startRadiusPort)),
                  endRadiusPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.endRadiusPort)),
                  
                  shadowColorPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.shadowColorPort)),
                  shadowOpacityPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.shadowOpacityPort)),
                  shadowRadiusPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.shadowRadiusPort)),
                  shadowOffsetPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.shadowOffsetPort)),
                  
                  sfSymbolPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.sfSymbolPort)),
                  
                  videoURLPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.videoURLPort)),
                  volumePort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.volumePort)),

                  spacingBetweenGridColumnsPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.spacingBetweenGridColumnsPort)),
                  spacingBetweenGridRowsPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.spacingBetweenGridRowsPort)),
                  itemAlignmentWithinGridCellPort: .init(inputPort: NodeConnectionType_V19.NodeConnectionType(previousInstance: previousInstance.itemAlignmentWithinGridCellPort)),
