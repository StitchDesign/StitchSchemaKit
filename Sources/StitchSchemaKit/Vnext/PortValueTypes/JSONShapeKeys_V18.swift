...
public enum JSONShapeKeys_V18: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V18
    public typealias PreviousInstance = JSONShapeKeys_V17.JSONShapeKeys
    // MARK: - endif
...
extension JSONShapeKeys_V18.JSONShapeKeys: StitchVersionedCodable {
    public init(previousInstance: JSONShapeKeys_V18.PreviousInstance) {
        fatalError()
    }
}
