...
public enum LayerSize_V18: StitchSchemaVersionable {
    // MARK: - ensure versions are correct
    static var version: StitchSchemaVersion = StitchSchemaVersion._V18
    public typealias PreviousInstance = LayerSize_V17.LayerSize
    // MARK: - endif
...
extension LayerSize_V18.LayerSize: StitchVersionedCodable {
    public init(previousInstance: LayerSize_V18.PreviousInstance) {
